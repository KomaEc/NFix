...
public class BindingBuilder<T> extends AbstractBindingBuilder<T> implements AnnotatedBindingBuilder<T> {
   ...
   public String toString() {
      String var1 = String.valueOf(String.valueOf(this.getBinding().getKey().getTypeLiteral()));
      return (new StringBuilder(16 + var1.length())).append("BindingBuilder<").append(var1).append(">").toString();
   }
