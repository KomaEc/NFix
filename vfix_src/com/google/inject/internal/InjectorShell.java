...
final class InjectorShell {
   ...
   private InjectorShell(InjectorShell.Builder builder, List<Element> elements, InjectorImpl injector) {
   ...
   private static void bindInjector(InjectorImpl injector) {
      ...
      InjectorShell.InjectorFactory injectorFactory = new InjectorShell.InjectorFactory(injector);
   ...
   private static void bindLogger(InjectorImpl injector) {
      ...
      InjectorShell.LoggerFactory loggerFactory = new InjectorShell.LoggerFactory();
   ...
   // $FF: synthetic method
   InjectorShell(InjectorShell.Builder x0, List x1, InjectorImpl x2, Object x3) {
      this(x0, x1, x2);
   }
   ...
   static class Builder {
      ...
      List<InjectorShell> build(Initializer initializer, ProcessedBindingData bindingData, Stopwatch stopwatch, Errors errors) {
         ...
         if (this.parent == null) {
            this.modules.add(0, new InjectorShell.RootModule());
         } else {
         ...
         while(i$.hasNext()) {
            InjectorShell.Builder builder = (InjectorShell.Builder)i$.next();
