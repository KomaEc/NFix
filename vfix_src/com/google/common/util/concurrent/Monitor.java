   ...
   public boolean enter(long time, TimeUnit unit) {
      ...
      if (!this.fair && lock.tryLock()) {
         ...
         try {
            while(true) {
               try {
                  boolean var10 = lock.tryLock(timeoutNanos, TimeUnit.NANOSECONDS);
                  return var10;
      ...
      if (guard.monitor != this) {
         ...
         try {
            ...
            try {
               while(true) {
                  try {
                     interrupt = locked = guard.isSatisfied() || this.awaitNanos(guard, timeoutNanos, signalBeforeWaiting);
   ...
   public boolean waitForUninterruptibly(Monitor.Guard guard, long time, TimeUnit unit) {
      ...
      if (!(guard.monitor == this & this.lock.isHeldByCurrentThread())) {
         ...
         try {
            while(true) {
               try {
                  boolean var11 = this.awaitNanos(guard, timeoutNanos, signalBeforeWaiting);
                  return var11;
