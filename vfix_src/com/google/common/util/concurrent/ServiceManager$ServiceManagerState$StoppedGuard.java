...
final class ServiceManager$ServiceManagerState$StoppedGuard extends Monitor.Guard {
   // $FF: synthetic field
   final ServiceManager.ServiceManagerState this$0;

   ServiceManager$ServiceManagerState$StoppedGuard(ServiceManager.ServiceManagerState this$0) {
