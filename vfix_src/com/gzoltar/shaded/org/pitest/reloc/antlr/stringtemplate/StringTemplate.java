...
import com.gzoltar.shaded.org.pitest.reloc.antlr.stringtemplate.language.ActionLexer;
import com.gzoltar.shaded.org.pitest.reloc.antlr.stringtemplate.language.ActionParser;
...
import com.gzoltar.shaded.org.pitest.reloc.antlr.stringtemplate.language.FormalArgument;
import com.gzoltar.shaded.org.pitest.reloc.antlr.stringtemplate.language.NewlineRef;
import com.gzoltar.shaded.org.pitest.reloc.antlr.stringtemplate.language.StringTemplateAST;
import com.gzoltar.shaded.org.pitest.reloc.antlr.stringtemplate.language.TemplateParser;
...
public class StringTemplate {
      ...
      if (value != null && name != null) {
         if (name.indexOf(46) >= 0) {
            ...
            if (o == null) {
               ...
               StringTemplate.STAttributeList v = null;
               if (o.getClass() == StringTemplate.STAttributeList.class) {
                  v = (StringTemplate.STAttributeList)o;
               } else if (o instanceof List) {
                  List listAttr = (List)o;
                  v = new StringTemplate.STAttributeList(listAttr.size());
                  v.addAll(listAttr);
                  this.rawSetAttribute(this.attributes, name, v);
               } else {
                  v = new StringTemplate.STAttributeList();
                  this.rawSetAttribute(this.attributes, name, v);
                  v.add(o);
               }
   ...
   protected void setAttribute(String aggrSpec, Object[] values) {
      ...
      if (values != null && properties.size() != 0) {
         if (values.length != properties.size()) {
            ...
            StringTemplate.Aggregate aggr = new StringTemplate.Aggregate();
   ...
   protected void breakTemplateIntoChunks() {
      if (this.pattern != null) {
         try {
            ...
            chunkStream.setTokenObjectClass("com.gzoltar.shaded.org.pitest.reloc.antlr.stringtemplate.language.ChunkToken");
   ...
   public ASTExpr parseAction(String action) {
      ...
      parser.setASTNodeClass("com.gzoltar.shaded.org.pitest.reloc.antlr.stringtemplate.language.StringTemplateAST");
      lexer.setTokenObjectClass("com.gzoltar.shaded.org.pitest.reloc.antlr.stringtemplate.language.StringTemplateToken");
      Object a = null;
