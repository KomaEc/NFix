...
import com.gzoltar.shaded.org.pitest.reloc.antlr.common.actions.java.ActionLexer;
   ...
   public void gen(LexerGrammar var1) throws IOException {
      ...
      try {
         ...
         if (this.grammar.superClass != null) {
            ...
            var3 = "com.gzoltar.shaded.org.pitest.reloc.antlr.common." + this.grammar.getSuperClass();
         }
