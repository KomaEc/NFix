...
import com.gzoltar.shaded.org.pitest.reloc.antlr.common.actions.csharp.ActionLexer;
...
public class CSharpCodeGenerator extends CodeGenerator {
   ...
   public void gen(OneOrMoreBlock var1) {
      ...
      String var2;
      if (var1.getLabel() != null) {
         var2 = "_cnt_" + var1.getLabel();
      } else {
         var2 = "_cnt" + var1.ID;
      }

      this.println("int " + var2 + "=0;");
      String var3;
      if (var1.getLabel() != null) {
         var3 = var1.getLabel();
      } else {
      ...
      if (var6) {
         ...
         this.println("if ((" + var2 + " >= 1) && " + var8 + ") goto " + var3 + "_breakloop;");
      }

      CSharpBlockFinishingInfo var9 = this.genCommonBlock(var1, false);
      this.genBlockFinish(var9, "if (" + var2 + " >= 1) { goto " + var3 + "_breakloop; } else { " + this.throwNoViable + "; }");
      this.println(var2 + "++;");
      --this.tabs;
   ...
   public void genBody(ParserGrammar var1) throws IOException {
      ...
      if (this.grammar.superClass != null) {
         ...
         var4 = "com.gzoltar.shaded.org.pitest.reloc.antlr.common." + this.grammar.getSuperClass();
      }
         ...
         for(var21 = var10; var21 >= 0; --var21) {
            ...
            for(var22 = 0; var22 < var1.alternatives.size(); ++var22) {
               ...
               if (var4 && suitableForCaseExpression(var24)) {
                  ...
                  String var16;
                  if (this.grammar instanceof LexerGrammar) {
                     int var15 = var24.lookaheadDepth;
                     if (var15 == Integer.MAX_VALUE) {
                        var15 = this.grammar.maxk;
                     }

                     while(var15 >= 1 && var24.cache[var15].containsEpsilon()) {
                        --var15;
                     }

                     if (var15 != var21) {
                        if (this.DEBUG_CODE_GENERATOR) {
                           System.out.println("ignoring alt because effectiveDepth!=altDepth;" + var15 + "!=" + var21);
                        }
                        continue;
                     }

                     var14 = this.lookaheadIsEmpty(var24, var15);
                     var16 = this.getLookaheadTestExpression(var24, var15);
                  } else {
                     var14 = this.lookaheadIsEmpty(var24, this.grammar.maxk);
                     var16 = this.getLookaheadTestExpression(var24, this.grammar.maxk);
                  }

                  if (var24.cache[1].fset.degree() > 127 && suitableForCaseExpression(var24)) {
                     if (var3 == 0) {
                        this.println("if " + var16);
                        this.println("{");
                     } else {
                        this.println("else if " + var16);
                        this.println("{");
                     }
                  } else if (var14 && var24.semPred == null && var24.synPred == null) {
                     if (var3 == 0) {
                        this.println("{");
                     } else {
                        this.println("else {");
                     ...
                     if (var24.semPred != null) {
                        ...
                        if ((this.grammar instanceof ParserGrammar || this.grammar instanceof LexerGrammar) && this.grammar.debuggingOutput) {
                           var16 = "(" + var16 + "&& fireSemanticPredicateEvaluated(antlr.debug.SemanticPredicateEventArgs.PREDICTING," + this.addSemPred(this.charFormatter.escapeString(var17)) + "," + var17 + "))";
                        } else {
                           var16 = "(" + var16 + "&&(" + var17 + "))";
                        }
                     }
                     ...
                     if (var3 > 0) {
                        if (var24.synPred != null) {
                           ...
                           ++this.tabs;
                           ++this.blockNestingLevel;
                           this.genSynPred(var24.synPred, var16);
                           ++var5;
                        } else {
                           this.println("else if " + var16 + " {");
                        }
   ...
   public String getASTCreateString(String var1) {
      ...
      String var4 = null;
      boolean var5 = false;
      int var6 = var1.indexOf(44);
      if (var6 != -1) {
         var3 = var1.substring(0, var6);
         var4 = var1.substring(var6 + 1, var1.length());
         var6 = var4.indexOf(44);
         if (var6 != -1) {
            var5 = true;
         }
      }
