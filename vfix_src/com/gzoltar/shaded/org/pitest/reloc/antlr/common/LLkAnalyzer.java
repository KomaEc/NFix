...
public class LLkAnalyzer implements LLkGrammarAnalyzer {
   ...
   public boolean deterministicImpliedPath(BlockWithImpliedExitPath var1) {
      boolean var2 = true;
      Vector var3 = var1.getAlternatives();
      int var4 = var3.size();
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         Alternative var6 = var1.getAlternativeAt(var5);
         if (var6.head instanceof BlockEndElement) {
         ...
         do {
            var9 = false;
            if (this.DEBUG_ANALYZER) {
               System.out.println("checking depth " + var7 + "<=" + this.grammar.maxk);
            }

            Lookahead var10 = var1.next.look(var7);
            var1.exitCache[var7] = var10;
            this.currentBlock.alti = var5;
            Lookahead var11 = this.getAltLookahead(var1, var5, var7);
            if (this.DEBUG_ANALYZER) {
               System.out.println("follow is " + var10.toString(",", this.charFormatter, this.grammar));
            }
            ...
            var8[var7] = var10.intersection(var11);
            if (this.DEBUG_ANALYZER) {
               System.out.println("intersection at depth " + var7 + " is " + var8[var7]);
            }
         ...
         } while(var9 && var7 <= this.grammar.maxk);

         if (var9) {
            var2 = false;
            var6.lookaheadDepth = Integer.MAX_VALUE;
            ...
            if (var1.warnWhenFollowAmbig && var1.generateAmbigWarnings) {
               if (var1.greedy && var1.greedySet && !(var12.head instanceof BlockEndElement)) {
                  ...
                  this.tool.errorHandler.warnAltExitAmbiguity(this.grammar, var1, this.lexicalAnalysis, this.grammar.maxk, var8, var5);
               }
            }
         } else {
            var6.lookaheadDepth = Math.max(var6.lookaheadDepth, var7);
            var1.exitLookaheadDepth = Math.max(var1.exitLookaheadDepth, var7);
         }
      }
   ...
   private Lookahead getAltLookahead(AlternativeBlock var1, int var2, int var3) {
      Alternative var4 = var1.getAlternativeAt(var2);
      AlternativeElement var5 = var4.head;
      Lookahead var6;
      if (var4.cache[var3] == null) {
         var6 = var5.look(var3);
         var4.cache[var3] = var6;
      } else {
         var6 = var4.cache[var3];
      }
