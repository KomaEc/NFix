...
public class ANTLRParser extends LLkParser implements ANTLRTokenTypes {
   ...
   public final void lexerSpec(String var1) throws RecognitionException, TokenStreamException {
      ...
      if (this.inputState.guessing == 0) {
         this.behavior.startLexer(this.getFilename(), var5, var4, var1);
      }
   ...
   public final void treeParserSpec(String var1) throws RecognitionException, TokenStreamException {
      ...
      switch(this.LA(1)) {
      case 27:
         var3 = this.superClass();
      case 16:
         if (this.inputState.guessing == 0) {
            this.behavior.startTreeWalker(this.getFilename(), var4, var3, var1);
         }
   ...
   public final void parserSpec(String var1) throws RecognitionException, TokenStreamException {
      ...
      case 16:
         if (this.inputState.guessing == 0) {
            this.antlrTool.warning("use 'class X extends Parser'", this.getFilename(), var4.getLine(), var4.getColumn());
         }
         break;
      default:
         throw new NoViableAltException(this.LT(1), this.getFilename());
      ...
      if (this.inputState.guessing == 0) {
         this.behavior.startParser(this.getFilename(), var4, var3, var1);
      }
   ...
   public final void lexerOptionsSpec() throws RecognitionException, TokenStreamException {
      ...
      while(true) {
         ...
         case 18:
            this.match(18);
            this.match(15);
            BitSet var1 = this.charSet();
            this.match(16);
            if (this.inputState.guessing == 0) {
               this.behavior.setCharVocabulary(var1);
            }
            break;
         case 24:
         case 41:
            Token var2 = this.id();
            this.match(15);
            Token var3 = this.optionValue();
            if (this.inputState.guessing == 0) {
               this.behavior.setGrammarOption(var2, var3);
            }
   ...
   public final BitSet setBlockElement() throws RecognitionException, TokenStreamException {
      ...
      this.match(19);
      if (this.inputState.guessing == 0) {
         var4 = ANTLRLexer.tokenTypeForCharLiteral(var1.getText());
         var3 = BitSet.of(var4);
      }
      ...
      case 22:
         ...
         this.match(19);
         if (this.inputState.guessing == 0) {
            int var5 = ANTLRLexer.tokenTypeForCharLiteral(var2.getText());
            if (var5 < var4) {
               this.antlrTool.error("Malformed range line ", this.getFilename(), var1.getLine(), var1.getColumn());
            }
   ...
   public final void rule() throws RecognitionException, TokenStreamException {
      ...
      case 41:
         ...
         case 37:
            if (this.inputState.guessing == 0) {
               this.behavior.defineRuleName(var11, var8, var10, var9);
            }
                  ...
                  case 36:
                     ...
                     case 36:
                        ...
                        case 36:
                           ...
                           case 41:
                              if (this.inputState.guessing == 0) {
                                 this.behavior.endRule(var11.getText());
                              }
   ...
   public final void range(Token var1) throws RecognitionException, TokenStreamException {
      ...
      case 24:
         ...
         int var11 = this.ast_type_spec();
         if (this.inputState.guessing == 0) {
            this.behavior.refTokenRange(var8, var9, var1, var11, this.lastInRule());
         }
         break;
      case 19:
         var2 = this.LT(1);
   ...
   public final void terminal(Token var1) throws RecognitionException, TokenStreamException {
      ...
      case 6:
         var5 = this.LT(1);
         this.match(6);
         var9 = this.ast_type_spec();
         if (this.inputState.guessing == 0) {
            this.behavior.refStringLiteral(var5, var1, var9, this.lastInRule());
         }
         break;
      case 19:
         var2 = this.LT(1);
      ...
      case 24:
         ...
         case 50:
            if (this.inputState.guessing == 0) {
               this.behavior.refToken((Token)null, var3, var1, var8, false, var9, this.lastInRule());
            }
      ...
      case 50:
         ...
         var9 = this.ast_type_spec();
         if (this.inputState.guessing == 0) {
            this.behavior.refWildcard(var6, var1, var9);
         }
         break;
      default:
         throw new NoViableAltException(this.LT(1), this.getFilename());
   ...
   public final void notTerminal(Token var1) throws RecognitionException, TokenStreamException {
      ...
      case 24:
         var3 = this.LT(1);
         this.match(24);
         int var5 = this.ast_type_spec();
         if (this.inputState.guessing == 0) {
            this.behavior.refToken((Token)null, var3, var1, (Token)null, true, var5, this.lastInRule());
         }
         break;
      default:
         throw new NoViableAltException(this.LT(1), this.getFilename());
