...
public class Tool {
   ...
   public void copyFile(String var1, String var2) throws IOException {
      ...
      try {
         if (!var3.exists() || !var3.isFile()) {
            ...
            while(true) {
               int var9 = var5.read(var8, 0, 1024);
               if (var9 == -1) {
                  return;
               }
   ...
   public int doEverything(String[] var1) {
      com.gzoltar.shaded.org.pitest.reloc.antlr.common.preprocessor.Tool var2 = new com.gzoltar.shaded.org.pitest.reloc.antlr.common.preprocessor.Tool(this, var1);
      ...
      if (!var3) {
         ...
         try {
            ...
            String var10 = "com.gzoltar.shaded.org.pitest.reloc.antlr.common." + this.getLanguage(var8) + "CodeGenerator";

            try {
               CodeGenerator var11 = (CodeGenerator)Utils.createInstanceOf(var10);
               var11.setBehavior(var8);
               var11.setAnalyzer(var7);
               var11.setTool(this);
               var11.gen();
            } catch (ClassNotFoundException var13) {
               this.panic("Cannot instantiate code-generator: " + var10);
            } catch (InstantiationException var14) {
               this.panic("Cannot instantiate code-generator: " + var10);
            } catch (IllegalArgumentException var15) {
               this.panic("Cannot instantiate code-generator: " + var10);
            } catch (IllegalAccessException var16) {
               this.panic("code-generator class '" + var10 + "' is not accessible");
            }
