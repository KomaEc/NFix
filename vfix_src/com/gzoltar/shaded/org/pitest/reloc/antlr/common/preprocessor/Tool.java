...
public class Tool {
   ...
   protected com.gzoltar.shaded.org.pitest.reloc.antlr.common.Tool antlrTool;

   public Tool(com.gzoltar.shaded.org.pitest.reloc.antlr.common.Tool var1, String[] var2) {
      this.antlrTool = var1;
      this.processArguments(var2);
   }

   public static void main(String[] var0) {
      com.gzoltar.shaded.org.pitest.reloc.antlr.common.Tool var1 = new com.gzoltar.shaded.org.pitest.reloc.antlr.common.Tool();
      ...
      for(int var2 = 0; var2 < var1.length; ++var2) {
         if (var1[var2].length() == 0) {
            ...
            if (File.separator.equals("\\") && var1[var2].indexOf(47) != -1) {
               ...
               com.gzoltar.shaded.org.pitest.reloc.antlr.common.Tool var10001 = this.antlrTool;
               this.grammars = com.gzoltar.shaded.org.pitest.reloc.antlr.common.Tool.parseSeparatedList(var1[var2 + 1], ';');
               ++var2;
            }
