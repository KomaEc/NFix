...
import com.gzoltar.shaded.org.pitest.reloc.antlr.common.ASdebug.ASDebugStream;
import com.gzoltar.shaded.org.pitest.reloc.antlr.common.ASdebug.IASDebugStream;
import com.gzoltar.shaded.org.pitest.reloc.antlr.common.ASdebug.TokenOffsetInfo;
...
public class TokenStreamRewriteEngine implements TokenStream, IASDebugStream {
   ...
   protected void addToSortedRewriteList(TokenStreamRewriteEngine.RewriteOperation var1) {
      this.addToSortedRewriteList("default", var1);
   }

   protected void addToSortedRewriteList(String var1, TokenStreamRewriteEngine.RewriteOperation var2) {
      List var3 = this.getProgram(var1);
      Comparator var4 = new Comparator() {
         public int compare(Object var1, Object var2) {
            TokenStreamRewriteEngine.RewriteOperation var3 = (TokenStreamRewriteEngine.RewriteOperation)var1;
            TokenStreamRewriteEngine.RewriteOperation var4 = (TokenStreamRewriteEngine.RewriteOperation)var2;
      ...
      if (var5 < 0) {
         ...
         while(true) {
            if (var5 >= 0) {
               TokenStreamRewriteEngine.RewriteOperation var6 = (TokenStreamRewriteEngine.RewriteOperation)var3.get(var5);
            ...
            ++var5;
            if (var2 instanceof TokenStreamRewriteEngine.ReplaceOp) {
               boolean var9 = false;

               int var7;
               for(var7 = var5; var7 < var3.size(); ++var7) {
                  TokenStreamRewriteEngine.RewriteOperation var8 = (TokenStreamRewriteEngine.RewriteOperation)var3.get(var5);
                  if (var8.index != var2.index) {
                     break;
                  }

                  if (var8 instanceof TokenStreamRewriteEngine.ReplaceOp) {
                     var3.set(var5, var2);
                     var9 = true;
                     break;
                  }
   ...
   public void insertBefore(String var1, int var2, String var3) {
      this.addToSortedRewriteList(var1, new TokenStreamRewriteEngine.InsertBeforeOp(var2, var3));
   }
   ...
   public void replace(String var1, int var2, int var3, String var4) {
      this.addToSortedRewriteList(new TokenStreamRewriteEngine.ReplaceOp(var2, var3, var4));
   }
   ...
   public String toString(String var1, int var2, int var3) {
      ...
      if (var4 != null && var4.size() != 0) {
         ...
         while(var7 >= 0 && var7 <= var3 && var7 < this.tokens.size()) {
            if (var6 < var4.size()) {
               TokenStreamRewriteEngine.RewriteOperation var8 = (TokenStreamRewriteEngine.RewriteOperation)var4.get(var6);

               while(var8.index < var7 && var6 < var4.size()) {
                  ++var6;
                  if (var6 < var4.size()) {
                     var8 = (TokenStreamRewriteEngine.RewriteOperation)var4.get(var6);
                  }
               }
         ...
         for(int var10 = var6; var10 < var4.size(); ++var10) {
            TokenStreamRewriteEngine.RewriteOperation var9 = (TokenStreamRewriteEngine.RewriteOperation)var4.get(var10);
