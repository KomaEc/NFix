...
import com.gzoltar.shaded.org.pitest.reloc.antlr.common.actions.cpp.ActionLexer;
...
public class CppCodeGenerator extends CodeGenerator {
   ...
   public void gen(OneOrMoreBlock var1) {
      ...
      if (var6) {
         ...
         this.println("if ( " + var2 + ">=1 && " + var8 + ") goto " + var3 + ";");
      }

      CppBlockFinishingInfo var9 = this.genCommonBlock(var1, false);
      this.genBlockFinish(var9, "if ( " + var2 + ">=1 ) { goto " + var3 + "; } else {" + this.throwNoViable + "}");
      this.println(var2 + "++;");
      --this.tabs;
      this.println("}");
      this.println(var3 + ":;");
                  ...
                  if (var24.cache[1].fset.degree() > 127 && suitableForCaseExpression(var24)) {
                     ...
                     if (var24.semPred != null) {
                        ...
                        if (!this.grammar.debuggingOutput || !(this.grammar instanceof ParserGrammar) && !(this.grammar instanceof LexerGrammar)) {
                           ...
                           var16 = "(" + var16 + "&& fireSemanticPredicateEvaluated(antlr.debug.SemanticPredicateEvent.PREDICTING," + this.addSemPred(this.charFormatter.escapeString(var17)) + "," + var17 + "))";
                        }
                     }
