...
import com.gzoltar.shaded.org.pitest.reloc.antlr.common.actions.python.ActionLexer;
import com.gzoltar.shaded.org.pitest.reloc.antlr.common.actions.python.CodeLexer;
...
public class PythonCodeGenerator extends CodeGenerator {
   ...
   public void gen(LexerGrammar var1) throws IOException {
      ...
      if (this.grammar.superClass != null) {
         ...
         var2 = "com.gzoltar.shaded.org.pitest.reloc.antlr.common." + this.grammar.getSuperClass();
      }
   ...
   public void gen(OneOrMoreBlock var1) {
      ...
      if (var6) {
         ...
         this.println("if " + var3 + " >= 1 and " + var8 + ":");
         ++this.tabs;
         this.println("break");
         --this.tabs;
      }
   ...
   public void gen(ZeroOrMoreBlock var1) {
      ...
      int var9 = this.tabs;
      PythonBlockFinishingInfo var8 = this.genCommonBlock(var1, false);
      this.genBlockFinish(var8, "break");
      this.tabs = var9;
      this.tabs = var2;
      --this.tabs;
         ...
         for(var22 = var11; var22 >= 0; --var22) {
            for(int var23 = 0; var23 < var1.alternatives.size(); ++var23) {
               ...
               if (var5 && suitableForCaseExpression(var25)) {
                  ...
                  String var17;
                  if (this.grammar instanceof LexerGrammar) {
                     int var16 = var25.lookaheadDepth;
                     if (var16 == Integer.MAX_VALUE) {
                        var16 = this.grammar.maxk;
                     }

                     while(var16 >= 1 && var25.cache[var16].containsEpsilon()) {
                        --var16;
                     }

                     if (var16 != var22) {
                        if (this.DEBUG_CODE_GENERATOR) {
                           System.out.println("ignoring alt because effectiveDepth!=altDepth" + var16 + "!=" + var22);
                        }
                        continue;
                     }

                     var15 = this.lookaheadIsEmpty(var25, var16);
                     var17 = this.getLookaheadTestExpression(var25, var16);
                  } else {
                     var15 = this.lookaheadIsEmpty(var25, this.grammar.maxk);
                     var17 = this.getLookaheadTestExpression(var25, this.grammar.maxk);
                  }

                  if (var25.cache[1].fset.degree() > 127 && suitableForCaseExpression(var25)) {
                     if (var4 == 0) {
                        this.println("<m1> if " + var17 + ":");
                     } else {
                        this.println("<m2> elif " + var17 + ":");
                     }
                  } else if (var15 && var25.semPred == null && var25.synPred == null) {
                     if (var4 == 0) {
                     ...
                     if (var25.semPred != null) {
                        ...
                        if ((this.grammar instanceof ParserGrammar || this.grammar instanceof LexerGrammar) && this.grammar.debuggingOutput) {
                           var17 = "(" + var17 + " and fireSemanticPredicateEvaluated(antlr.debug.SemanticPredicateEvent.PREDICTING, " + this.addSemPred(this.charFormatter.escapeString(var18)) + ", " + var18 + "))";
                        } else {
                           var17 = "(" + var17 + " and (" + var18 + "))";
                        }
                     }
                     ...
                     if (var4 > 0) {
                        if (var25.synPred != null) {
                           this.println("else:");
                           ++this.tabs;
                           this.genSynPred(var25.synPred, var17);
                           ++var6;
                        } else {
                           this.println("elif " + var17 + ":");
                        }
   ...
   public String getASTCreateString(Vector var1) {
      if (var1.size() == 0) {
         ...
         var2.append("com.gzoltar.shaded.org.pitest.reloc.antlr.common.make(");
   ...
   private void setupGrammarParameters(Grammar var1) {
      ...
      if (var1 instanceof ParserGrammar) {
         ...
         this.exceptionThrown = "com.gzoltar.shaded.org.pitest.reloc.antlr.common.RecognitionException";
   ...
   protected void _printAction(String var1) {
      if (var1 != null) {
         ...
         while(var3 > var2 && this.isspace(var1.charAt(var3))) {
            --var3;
         }
         ...
         for(int var8 = var2; var8 <= var3; ++var8) {
            ...
            case '\r':
               var7 = true;
               if (var8 + 1 <= var3 && var1.charAt(var8 + 1) == '\n') {
                  ++var8;
               }
               break;
            case ' ':
   ...
   protected void _printJavadoc(String var1) {
      ...
      for(int var5 = var3; var5 < var2; ++var5) {
         ...
         case '\r':
            var4 = true;
            if (var5 + 1 <= var2 && var1.charAt(var5 + 1) == '\n') {
               ++var5;
            }
            break;
         case ' ':
