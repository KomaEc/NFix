...
public class LLkDebuggingParser extends LLkParser implements DebuggingParser {
   ...
   protected void setupDebugging(TokenStream var1, TokenBuffer var2) {
      ...
      try {
         ...
         Class var3 = Utils.loadClass("com.gzoltar.shaded.org.pitest.reloc.antlr.common.parseview.ParseView");
         Constructor var4 = var3.getConstructor(class$antlr$debug$LLkDebuggingParser == null ? (class$antlr$debug$LLkDebuggingParser = class$("com.gzoltar.shaded.org.pitest.reloc.antlr.common.debug.LLkDebuggingParser")) : class$antlr$debug$LLkDebuggingParser, class$antlr$TokenStream == null ? (class$antlr$TokenStream = class$("com.gzoltar.shaded.org.pitest.reloc.antlr.common.TokenStream")) : class$antlr$TokenStream, class$antlr$TokenBuffer == null ? (class$antlr$TokenBuffer = class$("com.gzoltar.shaded.org.pitest.reloc.antlr.common.TokenBuffer")) : class$antlr$TokenBuffer);
