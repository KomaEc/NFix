...
import com.gzoltar.shaded.org.pitest.reloc.antlr.common.Utils;
import java.io.File;
...
public class Tool {
   ...
   public static void main(String[] var0) {
      if (var0.length != 1) {
         ...
         String var1 = "com.gzoltar.shaded.org.pitest.reloc.antlr.common.build.ANTLR";
         String var2 = var0[0];
         Tool var3 = new Tool();
   ...
   public void perform(String var1, String var2) {
      if (var1 != null && var2 != null) {
         ...
         try {
            ...
            try {
               if (!var1.startsWith("com.gzoltar.shaded.org.pitest.reloc.antlr.common.build.")) {
                  var3 = Utils.loadClass("com.gzoltar.shaded.org.pitest.reloc.antlr.common.build." + var1);
               }
         ...
         if (var3 != null && var5 != null) {
            try {
               var4 = var3.getMethod(var2, class$antlr$build$Tool == null ? (class$antlr$build$Tool = class$("com.gzoltar.shaded.org.pitest.reloc.antlr.common.build.Tool")) : class$antlr$build$Tool);
   ...
   public void antlr(String var1) {
      ...
      if (var2 != null) {
         ...
         com.gzoltar.shaded.org.pitest.reloc.antlr.common.Tool var3 = new com.gzoltar.shaded.org.pitest.reloc.antlr.common.Tool();
   ...
   public void error(String var1) {
      System.err.println("com.gzoltar.shaded.org.pitest.reloc.antlr.common.build.Tool: " + var1);
   }
