...
import com.gzoltar.shaded.org.pitest.reloc.antlr.common.ANTLRHashString;
...
public class PreprocessorLexer extends CharScanner implements PreprocessorTokenTypes, TokenStream {
   ...
   public final void mID_OR_KEYWORD(boolean var1) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      if (_tokenSet_9.member(this.LA(1)) && this.LA(2) >= 3 && this.LA(2) <= 255 && var5.getText().equals("header")) {
      ...
      } else if (_tokenSet_10.member(this.LA(1)) && this.LA(2) >= 3 && this.LA(2) <= 255 && var5.getText().equals("tokens")) {
         label68:
         while(true) {
            switch(this.LA(1)) {
            case '\t':
      ...
      } else if (_tokenSet_10.member(this.LA(1)) && var5.getText().equals("options")) {
         label59:
         while(true) {
            switch(this.LA(1)) {
            case '\t':
   ...
   protected final void mID(boolean var1) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      while(true) {
         ...
         case '`':
         default:
            int var5 = this.testLiteralsTable(new String(this.text.getBuffer(), var3, this.text.length() - var3), var4);
            if (var1 && var2 == null && var5 != -1) {
               var2 = this.makeToken(var5);
               var2.setText(new String(this.text.getBuffer(), var3, this.text.length() - var3));
            }
