...
import com.gzoltar.shaded.org.pitest.reloc.antlr.stringtemplate.language.InterfaceLexer;
import com.gzoltar.shaded.org.pitest.reloc.antlr.stringtemplate.language.InterfaceParser;
...
public class StringTemplateGroupInterface {
   ...
   public void defineTemplate(String name, LinkedHashMap formalArgs, boolean optional) {
      StringTemplateGroupInterface.TemplateDefinition d = new StringTemplateGroupInterface.TemplateDefinition(name, formalArgs, optional);
   ...
   public List getMissingTemplates(StringTemplateGroup group) {
      ...
      while(it.hasNext()) {
         ...
         StringTemplateGroupInterface.TemplateDefinition d = (StringTemplateGroupInterface.TemplateDefinition)this.templates.get(name);
   ...
   public List getMismatchedTemplates(StringTemplateGroup group) {
      ...
      while(true) {
         StringTemplateGroupInterface.TemplateDefinition d;
         do {
            if (!it.hasNext()) {
            ...
            String name = (String)it.next();
            d = (StringTemplateGroupInterface.TemplateDefinition)this.templates.get(name);
   ...
   protected String getTemplateSignature(StringTemplateGroupInterface.TemplateDefinition d) {
      StringBuffer buf = new StringBuffer();
      if (d.optional) {
         buf.append("optional ");
      }
