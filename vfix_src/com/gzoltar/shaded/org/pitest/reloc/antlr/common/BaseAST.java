...
import com.gzoltar.shaded.org.pitest.reloc.antlr.common.collections.impl.ASTEnumerator;
...
public abstract class BaseAST implements AST, Serializable {
   ...
   public int getNumberOfChildren() {
      ...
      if (var1 == null) {
         ...
         int var3;
         for(var3 = 1; var1.right != null; ++var3) {
            var1 = var1.right;
         }
   ...
   public static String decode(String var0) {
      ...
      for(int var2 = 0; var2 < var0.length(); ++var2) {
         ...
         if (var3 == '&') {
            ...
            char var5 = var0.charAt(var2 + 2);
            char var6 = var0.charAt(var2 + 3);
            char var7 = var0.charAt(var2 + 4);
            char var8 = var0.charAt(var2 + 5);
            if (var4 == 'a' && var5 == 'm' && var6 == 'p' && var7 == ';') {
               var1.append("&");
               var2 += 5;
            } else if (var4 == 'l' && var5 == 't' && var6 == ';') {
               var1.append("<");
               var2 += 4;
            } else if (var4 == 'g' && var5 == 't' && var6 == ';') {
               var1.append(">");
               var2 += 4;
            } else if (var4 == 'q' && var5 == 'u' && var6 == 'o' && var7 == 't' && var8 == ';') {
               var1.append("\"");
               var2 += 6;
            } else if (var4 == 'a' && var5 == 'p' && var6 == 'o' && var7 == 's' && var8 == ';') {
               var1.append("'");
               var2 += 6;
            } else {
               var1.append("&");
