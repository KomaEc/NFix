package com.gzoltar.shaded.org.pitest.reloc.asm;
      ...
      while(true) {
            ...
            if ("LocalVariableTable".equals(var28)) {
               ...
               if ((var2.b & 2) == 0) {
                  ...
                  for(var46 = var3; var29 > 0; --var29) {
                     ...
                     var11[var31].b = this.readUnsignedShort(var46 + 12);
                     var46 += 4;
                  }
               }
         ...
         while(var3 < var10) {
            ...
            case 7:
               ...
               boolean var51 = var4[var46 - 1] == 11;
               var50 = this.readClass(var46, var5);
               var46 = this.a[this.readUnsignedShort(var46 + 2)];
               String var53 = this.readUTF8(var46, var5);
               String var55 = this.readUTF8(var46 + 2, var5);
               if (var29 < 182) {
                  var1.visitFieldInsn(var29, var50, var53, var55);
               } else {
                  var1.visitMethodInsn(var29, var50, var53, var55, var51);
               }
            ...
            case 8:
               ...
               Handle var49 = (Handle)this.readConst(this.readUnsignedShort(var31), var5);
               var52 = this.readUnsignedShort(var31 + 2);
               Object[] var54 = new Object[var52];
               var31 += 4;

               for(int var35 = 0; var35 < var52; ++var35) {
                  var54[var35] = this.readConst(this.readUnsignedShort(var31), var5);
                  var31 += 2;
               }

               var46 = this.a[this.readUnsignedShort(var46 + 2)];
               String var56 = this.readUTF8(var46, var5);
               String var36 = this.readUTF8(var46 + 2, var5);
               var1.visitInvokeDynamicInsn(var56, var36, var49, var54);
               break;
            case 9:
            ...
            case 14:
               ...
               int var48 = this.readInt(var3 + 8);
               var33 = new Label[var48 - var31 + 1];
               var3 += 12;
               ...
               var1.visitTableSwitchInsn(var31, var48, var11[var46], var33);
               break;
            case 15:
               var3 = var3 + 4 - (var27 & 3);
               var46 = var27 + this.readInt(var3);
               ...
               for(var34 = 0; var34 < var31; ++var34) {
                  var32[var34] = this.readInt(var3);
                  var33[var34] = var11[var27 + this.readInt(var3 + 4)];
                  var3 += 8;
               }

               var1.visitLookupSwitchInsn(var11[var46], var32, var33);
               break;
            case 16:
            default:
         ...
         if ((var2.b & 2) == 0 && var18 != 0) {
            ...
            for(var43 = this.readUnsignedShort(var18); var43 > 0; --var43) {
               ...
               var50 = null;
               if (var45 != null) {
                  for(var52 = 0; var52 < var45.length; var52 += 3) {
                     if (var45[var52] == var29 && var45[var52 + 1] == var31) {
                        var50 = this.readUTF8(var45[var52 + 2], var5);
                        break;
                     }
                  }
               }

               var1.visitLocalVariable(this.readUTF8(var3 + 4, var5), this.readUTF8(var3 + 6, var5), var50, var11[var29], var11[var29 + var46], var31);
               var3 += 10;
            }
         }
