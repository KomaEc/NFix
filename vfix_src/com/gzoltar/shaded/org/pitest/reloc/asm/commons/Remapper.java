...
import com.gzoltar.shaded.org.pitest.reloc.asm.signature.SignatureReader;
import com.gzoltar.shaded.org.pitest.reloc.asm.signature.SignatureVisitor;
import com.gzoltar.shaded.org.pitest.reloc.asm.signature.SignatureWriter;
...
public abstract class Remapper {
   ...
   public Object mapValue(Object var1) {
      if (var1 instanceof Type) {
         ...
         return new Handle(var2.getTag(), this.mapType(var2.getOwner()), this.mapMethodName(var2.getOwner(), var2.getName(), var2.getDesc()), this.mapMethodDesc(var2.getDesc()));
      } else {
         return var1;
      }
   }
