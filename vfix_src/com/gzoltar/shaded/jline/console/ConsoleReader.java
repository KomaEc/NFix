package com.gzoltar.shaded.jline.console;

import com.gzoltar.shaded.jline.DefaultTerminal2;
import com.gzoltar.shaded.jline.Terminal;
import com.gzoltar.shaded.jline.Terminal2;
import com.gzoltar.shaded.jline.TerminalFactory;
import com.gzoltar.shaded.jline.UnixTerminal;
import com.gzoltar.shaded.jline.console.completer.CandidateListCompletionHandler;
import com.gzoltar.shaded.jline.console.completer.Completer;
import com.gzoltar.shaded.jline.console.completer.CompletionHandler;
import com.gzoltar.shaded.jline.console.history.History;
import com.gzoltar.shaded.jline.console.history.MemoryHistory;
import com.gzoltar.shaded.jline.internal.Ansi;
import com.gzoltar.shaded.jline.internal.Configuration;
import com.gzoltar.shaded.jline.internal.Curses;
import com.gzoltar.shaded.jline.internal.InputStreamReader;
import com.gzoltar.shaded.jline.internal.Log;
import com.gzoltar.shaded.jline.internal.NonBlockingInputStream;
import com.gzoltar.shaded.jline.internal.Nullable;
import com.gzoltar.shaded.jline.internal.Preconditions;
import com.gzoltar.shaded.jline.internal.Urls;
...
public class ConsoleReader {
   public static final String JLINE_NOBELL = "com.gzoltar.shaded.jline.nobell";
   public static final String JLINE_ESC_TIMEOUT = "com.gzoltar.shaded.jline.esc.timeout";
   public static final String JLINE_INPUTRC = "com.gzoltar.shaded.jline.inputrc";
   ...
   public static final String JLINE_COMPLETION_THRESHOLD = "com.gzoltar.shaded.jline.completion.threshold";
   ...
   public ConsoleReader(@Nullable String appName, InputStream in, OutputStream out, @Nullable Terminal term, @Nullable String encoding) throws IOException {
      ...
      this.bellEnabled = !Configuration.getBoolean("com.gzoltar.shaded.jline.nobell", true);
      ...
      this.autoprintThreshold = Configuration.getInteger("com.gzoltar.shaded.jline.completion.threshold", 100);
      ...
      if (terminal instanceof UnixTerminal && "/dev/tty".equals(((UnixTerminal)terminal).getSettings().getTtyDevice()) && Configuration.getBoolean("com.gzoltar.shaded.jline.sigcont", false)) {
         this.setupSigCont();
      }
   ...
   private URL getInputRc() throws IOException {
      String path = Configuration.getString("com.gzoltar.shaded.jline.inputrc");
      if (path == null) {
   ...
   void setInput(InputStream in) throws IOException {
      this.escapeTimeout = Configuration.getLong("com.gzoltar.shaded.jline.esc.timeout", 100L);
   ...
   public void setPrompt(String prompt) {
      this.prompt = prompt;
      this.promptLen = prompt == null ? 0 : this.wcwidth(Ansi.stripAnsi(this.lastLine(prompt)), 0);
   }
   ...
   public void drawLine() throws IOException {
      ...
      this.print(this.buf.buffer, 0, this.buf.length(), this.promptLen);
   ...
   private void drawBuffer(int clear) throws IOException {
      ...
      if (this.buf.cursor != this.buf.length() || clear != 0) {
         if (this.mask != null) {
            ...
            this.print(this.buf.buffer, this.buf.cursor, this.buf.length());
         }
      }
   ...
   public Object readBinding(KeyMap keys) throws IOException {
      ...
      do {
         ...
         if (o instanceof KeyMap) {
            ...
            otherKey = ((KeyMap)o).getAnotherKey();
            if (otherKey == null) {
         ...
         while(o == null && this.opBuffer.length() > 0) {
            ...
            this.opBuffer.setLength(this.opBuffer.length() - 1);
            otherKey = keys.getBound(this.opBuffer);
            if (otherKey instanceof KeyMap) {
               o = ((KeyMap)otherKey).getAnotherKey();
               if (o != null) {
   ...
   private int print(CharSequence buff, int cursorPos) throws IOException {
      return this.print(buff, 0, buff.length(), cursorPos);
   }

   private int print(CharSequence buff, int start, int end) throws IOException {
      return this.print(buff, start, end, this.getCursorPosition());
   }

   private int print(CharSequence buff, int start, int end, int cursorPos) throws IOException {
   ...
   public void print(CharSequence s) throws IOException {
      this.print(s, this.getCursorPosition());
   }
