...
public final class Log {
   ...
   static void logWithJul(Log.Level level, Object... messages) {
      Logger logger = Logger.getLogger("com.gzoltar.shaded.jline");
   ...
   private static java.util.logging.Level toJulLevel(Log.Level level) {
      switch(level) {
      case TRACE:
   ...
   static {
      ...
      output = System.err;
      useJul = Configuration.getBoolean("com.gzoltar.shaded.jline.log.jul");
   }
