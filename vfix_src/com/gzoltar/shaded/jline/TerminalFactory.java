...
public class TerminalFactory {
   public static final String JLINE_TERMINAL = "com.gzoltar.shaded.jline.terminal";
   ...
   public static synchronized Terminal create(String ttyDevice) {
      ...
      String type = Configuration.getString("com.gzoltar.shaded.jline.terminal");
      String tmp;
      if (type == null) {
         type = "auto";
   ...
   public static synchronized void configure(String type) {
      ...
      System.setProperty("com.gzoltar.shaded.jline.terminal", type);
   }
