...
import com.gzoltar.shaded.javassist.CodeConverter;
...
import com.gzoltar.shaded.javassist.bytecode.ClassFile;
...
public class Reflection implements Translator {
   ...
   static final String metaobjectClassName = "com.gzoltar.shaded.javassist.tools.reflect.Metaobject";
   static final String classMetaobjectClassName = "com.gzoltar.shaded.javassist.tools.reflect.ClassMetaobject";
   ...
   public void start(ClassPool pool) throws NotFoundException {
      this.classPool = pool;
      String var2 = "com.gzoltar.shaded.javassist.tools.reflect.Sample is not found or broken.";

      try {
         CtClass c = this.classPool.get("com.gzoltar.shaded.javassist.tools.reflect.Sample");
         ...
         throw new RuntimeException("com.gzoltar.shaded.javassist.tools.reflect.Sample is not found or broken.");
   ...
   public boolean makeReflective(CtClass clazz, CtClass metaobject, CtClass metaclass) throws CannotCompileException, CannotReflectException, NotFoundException {
      ...
      } else if (clazz.subclassOf(this.classPool.get("com.gzoltar.shaded.javassist.tools.reflect.ClassMetaobject"))) {
         throw new CannotReflectException("Cannot reflect a subclass of ClassMetaobject: " + clazz.getName());
      } else if (clazz.subclassOf(this.classPool.get("com.gzoltar.shaded.javassist.tools.reflect.Metaobject"))) {
   ...
   private boolean modifyClassfile(CtClass clazz, CtClass metaobject, CtClass metaclass) throws CannotCompileException, NotFoundException {
      if (clazz.getAttribute("Reflective") != null) {
         ...
         CtClass mlevel = this.classPool.get("com.gzoltar.shaded.javassist.tools.reflect.Metalevel");
         ...
         CtField f;
         if (addMeta) {
            f = new CtField(this.classPool.get("com.gzoltar.shaded.javassist.tools.reflect.Metaobject"), "_metaobject", clazz);
            f.setModifiers(4);
         ...
         f = new CtField(this.classPool.get("com.gzoltar.shaded.javassist.tools.reflect.ClassMetaobject"), "_classobject", clazz);
         f.setModifiers(10);
