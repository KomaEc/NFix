...
import com.gzoltar.shaded.javassist.bytecode.ExceptionsAttribute;
import com.gzoltar.shaded.javassist.bytecode.LineNumberAttribute;
import com.gzoltar.shaded.javassist.bytecode.LocalVariableAttribute;
import com.gzoltar.shaded.javassist.bytecode.LocalVariableTypeAttribute;
...
import com.gzoltar.shaded.javassist.bytecode.StackMap;
import com.gzoltar.shaded.javassist.bytecode.StackMapTable;
   ...
   public void useCflow(String name) throws CannotCompileException {
      ...
      while(true) {
         ...
         try {
            ...
            try {
               CtClass type = pool.get("com.gzoltar.shaded.javassist.runtime.Cflow");
