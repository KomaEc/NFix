...
import com.gzoltar.shaded.javassist.bytecode.DuplicateMemberException;
...
public class ProxyFactory {
   ...
   private static final String NULL_INTERCEPTOR_HOLDER = "com.gzoltar.shaded.javassist.util.proxy.RuntimeSupport";
   ...
   private static MethodInfo makeConstructor(String thisClassName, Constructor cons, ConstPool cp, Class superClass, boolean doHandlerInit) {
      ...
      code.addAload(0);
      code.addGetstatic("com.gzoltar.shaded.javassist.util.proxy.RuntimeSupport", "default_interceptor", HANDLER_TYPE);
      code.addPutfield(thisClassName, "handler", HANDLER_TYPE);
   ...
   private static MethodInfo makeWriteReplace(ConstPool cp) {
      ...
      code.addAload(0);
      code.addInvokestatic("com.gzoltar.shaded.javassist.util.proxy.RuntimeSupport", "makeSerializedProxy", "(Ljava/lang/Object;)Ljavassist/util/proxy/SerializedProxy;");
      code.addOpcode(176);
      minfo.setCodeAttribute(code.toCodeAttribute());
      return minfo;
   }
