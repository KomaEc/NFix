...
import com.gzoltar.shaded.javassist.bytecode.SyntheticAttribute;
...
public class AccessorMaker {
   ...
   static final String lastParamType = "com.gzoltar.shaded.javassist.runtime.Inner";
   ...
   public String getConstructor(CtClass c, String desc, MethodInfo orig) throws CompileError {
      ...
      if (consDesc != null) {
         ...
         consDesc = Descriptor.appendParameter("com.gzoltar.shaded.javassist.runtime.Inner", desc);
