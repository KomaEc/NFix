...
import com.gzoltar.shaded.javassist.compiler.ast.ASTree;
import com.gzoltar.shaded.javassist.compiler.ast.ArrayInit;
import com.gzoltar.shaded.javassist.compiler.ast.AssignExpr;
import com.gzoltar.shaded.javassist.compiler.ast.BinExpr;
import com.gzoltar.shaded.javassist.compiler.ast.CallExpr;
import com.gzoltar.shaded.javassist.compiler.ast.CastExpr;
import com.gzoltar.shaded.javassist.compiler.ast.CondExpr;
import com.gzoltar.shaded.javassist.compiler.ast.Declarator;
import com.gzoltar.shaded.javassist.compiler.ast.DoubleConst;
import com.gzoltar.shaded.javassist.compiler.ast.Expr;
import com.gzoltar.shaded.javassist.compiler.ast.FieldDecl;
import com.gzoltar.shaded.javassist.compiler.ast.InstanceOfExpr;
import com.gzoltar.shaded.javassist.compiler.ast.IntConst;
import com.gzoltar.shaded.javassist.compiler.ast.Keyword;
import com.gzoltar.shaded.javassist.compiler.ast.Member;
import com.gzoltar.shaded.javassist.compiler.ast.MethodDecl;
import com.gzoltar.shaded.javassist.compiler.ast.NewExpr;
import com.gzoltar.shaded.javassist.compiler.ast.Pair;
import com.gzoltar.shaded.javassist.compiler.ast.Stmnt;
import com.gzoltar.shaded.javassist.compiler.ast.StringL;
import com.gzoltar.shaded.javassist.compiler.ast.Symbol;
import com.gzoltar.shaded.javassist.compiler.ast.Variable;
import com.gzoltar.shaded.javassist.compiler.ast.Visitor;
...
public abstract class CodeGen extends Visitor implements Opcode, TokenId {
   ...
   protected void atClassObject2(String cname) throws CompileError {
      ...
      this.bytecode.addInvokestatic("com.gzoltar.shaded.javassist.runtime.DotClass", "fail", "(Ljava/lang/ClassNotFoundException;)Ljava/lang/NoClassDefFoundError;");
      this.bytecode.addOpcode(191);
      this.bytecode.write16bit(pc, this.bytecode.currentPc() - pc + 1);
   }
