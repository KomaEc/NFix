...
public class LLkDebuggingParser extends LLkParser implements DebuggingParser {
   ...
   protected void setupDebugging(TokenStream var1, TokenBuffer var2) {
      ...
      try {
         ...
         Class var3 = Utils.loadClass("groovyjarjarantlr.parseview.ParseView");
         Constructor var4 = var3.getConstructor(class$antlr$debug$LLkDebuggingParser == null ? (class$antlr$debug$LLkDebuggingParser = class$("groovyjarjarantlr.debug.LLkDebuggingParser")) : class$antlr$debug$LLkDebuggingParser, class$antlr$TokenStream == null ? (class$antlr$TokenStream = class$("groovyjarjarantlr.TokenStream")) : class$antlr$TokenStream, class$antlr$TokenBuffer == null ? (class$antlr$TokenBuffer = class$("groovyjarjarantlr.TokenBuffer")) : class$antlr$TokenBuffer);
