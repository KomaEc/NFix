...
public class Lookahead implements Cloneable {
   ...
   public String toString() {
      ...
      String var2 = "";
      String var3 = "";
      String var4 = this.fset.toString(",");
      if (this.containsEpsilon()) {
         var1 = "+<epsilon>";
      }

      if (this.cycle != null) {
         var2 = "; FOLLOW(" + this.cycle + ")";
      }

      if (this.epsilonDepth != null) {
         var3 = "; depths=" + this.epsilonDepth.toString(",");
      }

      return var4 + var1 + var2 + var3;
   }
   ...
   public String toString(String var1, CharFormatter var2) {
      ...
      String var4 = "";
      String var5 = "";
      String var6 = this.fset.toString(var1, var2);
      if (this.containsEpsilon()) {
         var3 = "+<epsilon>";
      }
   ...
   public String toString(String var1, Vector var2) {
      String var3 = "";
      String var4 = "";
      String var5 = this.fset.toString(var1, var2);
      if (this.cycle != null) {
