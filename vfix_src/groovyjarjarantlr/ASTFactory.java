...
public class ASTFactory {
   ...
   public Class getASTNodeType(int var1) {
      ...
      if (this.theASTNodeTypeClass != null) {
         ...
         return class$antlr$CommonAST == null ? (class$antlr$CommonAST = class$("groovyjarjarantlr.CommonAST")) : class$antlr$CommonAST;
      }
   }
   ...
   protected AST createUsingCtor(Token var1, String var2) {
      ...
      try {
         var3 = Utils.loadClass(var2);
         Class[] var5 = new Class[]{class$antlr$Token == null ? (class$antlr$Token = class$("groovyjarjarantlr.Token")) : class$antlr$Token};
