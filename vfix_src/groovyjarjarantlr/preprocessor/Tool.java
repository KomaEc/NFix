...
public class Tool {
   ...
   public Tool(groovyjarjarantlr.Tool var1, String[] var2) {
      this.antlrTool = var1;
      this.processArguments(var2);
   }

   public static void main(String[] var0) {
      groovyjarjarantlr.Tool var1 = new groovyjarjarantlr.Tool();
      ...
      for(int var2 = 0; var2 < var1.length; ++var2) {
         if (var1[var2].length() == 0) {
            ...
            if (File.separator.equals("\\") && var1[var2].indexOf(47) != -1) {
               ...
               groovyjarjarantlr.Tool var10001 = this.antlrTool;
               this.grammars = groovyjarjarantlr.Tool.parseSeparatedList(var1[var2 + 1], ';');
               ++var2;
            }
