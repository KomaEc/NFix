...
public class Tool {
   ...
   public int doEverything(String[] var1) {
      groovyjarjarantlr.preprocessor.Tool var2 = new groovyjarjarantlr.preprocessor.Tool(this, var1);
      ...
      if (!var3) {
         ...
         try {
            ...
            String var10 = "groovyjarjarantlr." + this.getLanguage(var8) + "CodeGenerator";
