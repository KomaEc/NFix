...
public class Tool {
   ...
   public static void main(String[] var0) {
      if (var0.length != 1) {
         ...
         String var1 = "groovyjarjarantlr.build.ANTLR";
         String var2 = var0[0];
         Tool var3 = new Tool();
   ...
   public void perform(String var1, String var2) {
      if (var1 != null && var2 != null) {
         ...
         try {
            ...
            try {
               if (!var1.startsWith("groovyjarjarantlr.build.")) {
                  var3 = Utils.loadClass("groovyjarjarantlr.build." + var1);
               }
         ...
         if (var3 != null && var5 != null) {
            try {
               var4 = var3.getMethod(var2, class$antlr$build$Tool == null ? (class$antlr$build$Tool = class$("groovyjarjarantlr.build.Tool")) : class$antlr$build$Tool);
   ...
   public void antlr(String var1) {
      ...
      if (var2 != null) {
         ...
         groovyjarjarantlr.Tool var3 = new groovyjarjarantlr.Tool();
