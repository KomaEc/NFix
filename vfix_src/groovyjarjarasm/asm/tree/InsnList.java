...
public class InsnList {
   ...
   public ListIterator iterator(int var1) {
      return new InsnList$InsnListIterator(this, var1, (InsnList$1)null);
   }
   ...
   public void set(AbstractInsnNode var1, AbstractInsnNode var2) {
      if (!check || this.contains(var1) && var2.index == -1) {
   ...
   public void insert(AbstractInsnNode var1, InsnList var2) {
      if (check && (!this.contains(var1) || var2 == this)) {
         throw new IllegalArgumentException();
      } else if (var2.size != 0) {
         this.size += var2.size;
   ...
   private void removeAll(boolean var1) {
      AbstractInsnNode var3;
      if (var1) {
   ...
   // $FF: synthetic method
   static AbstractInsnNode[] access$100(InsnList var0) {
      return var0.cache;
   }

   // $FF: synthetic method
   static AbstractInsnNode[] access$102(InsnList var0, AbstractInsnNode[] var1) {
      return var0.cache = var1;
   }
}
