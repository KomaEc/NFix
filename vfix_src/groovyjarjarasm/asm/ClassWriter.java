...
public class ClassWriter implements ClassVisitor {
   ...
   public byte[] toByteArray() {
      ...
      var7.putShort(this.j).putShort(this.k).putShort(this.m);
      var7.putShort(this.n);

      int var8;
      for(var8 = 0; var8 < this.n; ++var8) {
         var7.putShort(this.o[var8]);
      }
      ...
      if (this.q != null) {
         var8 = this.q.b - 2;
         var7.putShort(this.newUTF8("SourceDebugExtension")).putInt(var8);
         var7.putByteArray(this.q.a, 2, var8);
      }
      ...
      if (this.I) {
         ClassWriter var9 = new ClassWriter(2);
         (new ClassReader(var7.a)).accept(var9, 4);
