...
public class JSRInlinerAdapter extends MethodNode implements Opcodes {
   ...
   public void visitJumpInsn(int var1, Label var2) {
      ...
      if (var1 == 168 && !this.subroutineHeads.containsKey(var3)) {
         this.subroutineHeads.put(var3, new JSRInlinerAdapter$Subroutine());
      }
   ...
   private void markSubroutines() {
      ...
      while(var2.hasNext()) {
         ...
         JSRInlinerAdapter$Subroutine var5 = (JSRInlinerAdapter$Subroutine)var3.getValue();
   ...
   private void markSubroutineWalk(JSRInlinerAdapter$Subroutine var1, int var2, BitSet var3) {
   ...
   private void markSubroutineWalkDFS(JSRInlinerAdapter$Subroutine var1, int var2, BitSet var3) {
      while(true) {
         AbstractInsnNode var4 = this.instructions.get(var2);
         if (var1.instructions.get(var2)) {
            return;
         }

         var1.instructions.set(var2);
         if (var3.get(var2)) {
         ...
         var3.set(var2);
         int var6;
         if (var4.getType() == 6 && var4.getOpcode() != 168) {
   ...
   private void emitCode() {
      ...
      var1.add(new JSRInlinerAdapter$Instantiation(this, (JSRInlinerAdapter$Instantiation)null, this.mainSubroutine, (JSRInlinerAdapter$1)null));
         ...
         if (var9.getType() == 7) {
            ...
            if (var9.getOpcode() != 169) {
               if (var9.getOpcode() == 168) {
                  ...
                  JSRInlinerAdapter$Subroutine var20 = (JSRInlinerAdapter$Subroutine)this.subroutineHeads.get(var11);
                  JSRInlinerAdapter$Instantiation var13 = new JSRInlinerAdapter$Instantiation(this, var1, var20, (JSRInlinerAdapter$1)null);
               ...
               for(JSRInlinerAdapter$Instantiation var12 = var1; var12 != null; var12 = var12.previous) {
                  if (var12.subroutine.ownsInstruction(var7)) {
   ...
   // $FF: synthetic method
   static BitSet access$100(JSRInlinerAdapter var0) {
      return var0.dualCitizens;
   }
}
