...
public class GeneratorAdapter extends LocalVariablesSorter {
   ...
   public GeneratorAdapter(MethodVisitor var1, int var2, String var3, String var4) {
      super(var2, var4, var1);
      this.localTypes = new ArrayList();
      this.access = var2;
      this.returnType = Type.getReturnType(var4);
      this.argumentTypes = Type.getArgumentTypes(var4);
   }

   public GeneratorAdapter(int var1, Method var2, MethodVisitor var3) {
      super(var1, var2.getDescriptor(), var3);
      this.localTypes = new ArrayList();
      this.access = var1;
      this.returnType = var2.getReturnType();
      this.argumentTypes = var2.getArgumentTypes();
   }
   ...
   public void ifCmp(Type var1, int var2, Label var3) {
      switch(var1.getSort()) {
      case 6:
         this.mv.visitInsn(var2 != 156 && var2 != 157 ? 149 : 150);
         break;
      case 7:
         this.mv.visitInsn(148);
         break;
      case 8:
         this.mv.visitInsn(var2 != 156 && var2 != 157 ? 151 : 152);
         break;
      case 9:
      case 10:
         switch(var2) {
   ...
   private void invokeInsn(int var1, Type var2, Method var3) {
      String var4 = var2.getSort() == 9 ? var2.getDescriptor() : var2.getInternalName();
      this.mv.visitMethodInsn(var1, var4, var3.getName(), var3.getDescriptor());
   }

   public void invokeVirtual(Type var1, Method var2) {
      this.invokeInsn(182, var1, var2);
   }

   public void invokeConstructor(Type var1, Method var2) {
      this.invokeInsn(183, var1, var2);
   }

   public void invokeStatic(Type var1, Method var2) {
      this.invokeInsn(184, var1, var2);
   }

   public void invokeInterface(Type var1, Method var2) {
      this.invokeInsn(185, var1, var2);
   }

   public void invokeDynamic(Method var1) {
      this.invokeInsn(186, Type.getObjectType("java/lang/dyn/Dynamic"), var1);
   }
   ...
   public void catchException(Label var1, Label var2, Type var3) {
      if (var3 == null) {
         this.mv.visitTryCatchBlock(var1, var2, this.mark(), (String)null);
      } else {
         this.mv.visitTryCatchBlock(var1, var2, this.mark(), var3.getInternalName());
      }
