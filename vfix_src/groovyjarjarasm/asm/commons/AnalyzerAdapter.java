...
public class AnalyzerAdapter extends MethodAdapter {
   ...
   private List labels;
   private final Map uninitializedTypes = new HashMap();
   ...
   public AnalyzerAdapter(String var1, int var2, String var3, String var4, MethodVisitor var5) {
      ...
      for(int var7 = 0; var7 < var6.length; ++var7) {
         ...
         case 8:
            ...
            break;
         case 9:
            this.locals.add(var6[var7].getDescriptor());
            break;
         default:
            this.locals.add(var6[var7].getInternalName());
         }
      }
   ...
   public void visitMethodInsn(int var1, String var2, String var3, String var4) {
      ...
      if (var1 != 184 && var1 != 186) {
         ...
         if (var1 == 183 && var3.charAt(0) == '<') {
            Object var6;
            if (var5 == Opcodes.UNINITIALIZED_THIS) {
               var6 = var2;
            } else {
               var6 = this.uninitializedTypes.get(var5);
            }

            int var7;
            for(var7 = 0; var7 < this.locals.size(); ++var7) {
               if (this.locals.get(var7) == var5) {
                  this.locals.set(var7, var6);
               }
            }

            for(var7 = 0; var7 < this.stack.size(); ++var7) {
               if (this.stack.get(var7) == var5) {
                  this.stack.set(var7, var6);
               }
            }
         }
      }
   ...
   private Object get(int var1) {
      this.maxLocals = Math.max(this.maxLocals, var1);
