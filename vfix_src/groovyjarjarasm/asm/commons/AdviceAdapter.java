...
public abstract class AdviceAdapter extends GeneratorAdapter implements Opcodes {
   ...
   protected AdviceAdapter(MethodVisitor var1, int var2, String var3, String var4) {
      super(var1, var2, var3, var4);
      this.methodAccess = var2;
      this.methodDesc = var4;
      this.constructor = "<init>".equals(var3);
   }
   ...
   public void visitMethodInsn(int var1, String var2, String var3, String var4) {
      ...
      if (this.constructor) {
         Type[] var5 = Type.getArgumentTypes(var4);
         ...
         case 183:
            ...
            if (var7 == THIS && !this.superInitialized) {
               this.onMethodEnter();
               this.superInitialized = true;
         ...
         Type var8 = Type.getReturnType(var4);
