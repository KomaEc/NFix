   ...
   public void accept(ClassVisitor var1, Attribute[] var2, int var3) {
      ...
      for(var9 += 2; var16 > 0; --var16) {
         ...
         if (var15 == 0) {
            ...
            var68 = new String[this.readUnsignedShort(var15)];
            var15 += 2;

            for(var20 = 0; var20 < var68.length; ++var20) {
               var68[var20] = this.readClass(var15, var5);
               var15 += 2;
            }
         }

         MethodVisitor var36 = var1.visitMethod(var10, var11, var30, var21, var68);
         if (var36 != null) {
            if (var36 instanceof MethodWriter) {
               ...
               if (var37.b.J == this && var21 == var37.g) {
                  ...
                  if (var68 == null) {
                     var38 = var37.j == 0;
                  } else if (var68.length == var37.j) {
                     var38 = true;

                     for(var20 = var68.length - 1; var20 >= 0; --var20) {
                        var15 -= 2;
            ...
            if (var67 != 0) {
               AnnotationVisitor var69 = var36.visitAnnotationDefault();
               this.a(var67, var5, (String)null, var69);
               if (var69 != null) {
                  var69.visitEnd();
               }
            }
         ...
         if (var36 != null && var12 != 0) {
            int var70 = this.readUnsignedShort(var12);
            int var71 = this.readUnsignedShort(var12 + 2);
            ...
            while(true) {
               ...
               int var46;
               for(var12 += 2; var20 > 0; --var20) {
                  Label var72 = this.readLabel(this.readUnsignedShort(var12), var42);
                  ...
                  if (var46 == 0) {
                     var36.visitTryCatchBlock(var72, var44, var45, (String)null);
                  } else {
                     var36.visitTryCatchBlock(var72, var44, var45, this.readUTF8(this.a[var46], var5));
                  }
                  ...
                  if ("LocalVariableTable".equals(var27)) {
                     if (!var18) {
                        ...
                        for(var15 = var12 + 8; var32 > 0; --var32) {
                           var55 = this.readUnsignedShort(var15);
                           if (var42[var55] == null) {
                              var10000 = this.readLabel(var55, var42);
                              var10000.a |= 1;
                           }

                           var55 += this.readUnsignedShort(var15 + 2);
                           if (var42[var55] == null) {
                              var10000 = this.readLabel(var55, var42);
                              var10000.a |= 1;
                           }
                     ...
                     if (!var18) {
                        ...
                        for(var15 = var12 + 8; var32 > 0; --var32) {
                           ...
                           var42[var55].b = this.readUnsignedShort(var15 + 2);
                           var15 += 4;
                        }
                     }
               ...
               if (var74 != 0) {
                  var52 = new Object[var71];
                  var53 = new Object[var70];
                  if (var19) {
                     int var56 = 0;
                     if ((var10 & 8) == 0) {
                        if ("<init>".equals(var11)) {
                           var52[var56++] = Opcodes.UNINITIALIZED_THIS;
                        } else {
                           var52[var56++] = this.readClass(this.header + 2, var5);
                        }
                     }
                     ...
                     while(true) {
                        while(true) {
                           ...
                           case 'S':
                           case 'Z':
                              var52[var56++] = Opcodes.INTEGER;
                              break;
                           case 'D':
                              var52[var56++] = Opcodes.DOUBLE;
                              break;
                           case 'E':
                           case 'G':
                           case 'H':
                           ...
                           default:
                              ...
                              break label657;
                           case 'F':
                              var52[var56++] = Opcodes.FLOAT;
                              break;
                           case 'J':
                              var52[var56++] = Opcodes.LONG;
                              break;
                           case 'L':
                              ...
                              var52[var56++] = var30.substring(var32 + 1, var20++);
                              break;
                           case '[':
                              while(var30.charAt(var20) == '[') {
                                 ++var20;
                              ...
                              int var10001 = var56++;
                              ++var20;
                              var52[var10001] = var30.substring(var32, var20);
                           }
                        }
                     }
                  }
               ...
               while(true) {
                  ...
                  while(var12 < var41) {
                     ...
                     var77 = var42[var15];
                     if (var77 != null) {
                        var36.visitLabel(var77);
                        if (!var18 && var77.b > 0) {
                           var36.visitLineNumber(var77.b, var77);
                        }
                     }

                     while(true) {
                        int var57;
                        while(var52 != null && (var48 == var15 || var48 == -1)) {
                           if (var54 && !var19) {
                              if (var48 != -1) {
                                 var36.visitFrame(var47, var50, var52, var51, var53);
                              }
                           } else {
                              var36.visitFrame(-1, var49, var52, var51, var53);
                           }

                           if (var46 > 0) {
                              if (var54) {
                                 var57 = var4[var74++] & 255;
                              } else {
                                 var57 = 255;
                                 var48 = -1;
                              }
                              ...
                              if (var57 < 64) {
                                 ...
                                 var58 = var57 - 64;
                                 var74 = this.a(var53, 0, var74, var5, var42);
                                 var47 = 4;
                                 var51 = 1;
                              } else {
                                 var58 = this.readUnsignedShort(var74);
                                 var74 += 2;
                                 if (var57 == 247) {
                                    var74 = this.a(var53, 0, var74, var5, var42);
                                    var47 = 4;
                                    var51 = 1;
                                 } else if (var57 >= 248 && var57 < 251) {
                                    var47 = 2;
                                    var50 = 251 - var57;
                                    var49 -= var50;
                                    var51 = 0;
                                    ...
                                    for(var32 = var57 - 251; var32 > 0; --var32) {
                                       var74 = this.a(var52, var20++, var74, var5, var42);
                                    }
                                    ...
                                    var47 = 0;
                                    var59 = var50 = var49 = this.readUnsignedShort(var74);
                                    var74 += 2;

                                    for(var20 = 0; var59 > 0; --var59) {
                                       var74 = this.a(var52, var20++, var74, var5, var42);
                                    }

                                    var59 = var51 = this.readUnsignedShort(var74);
                                    var74 += 2;

                                    for(var20 = 0; var59 > 0; --var59) {
                                       var74 = this.a(var53, var20++, var74, var5, var42);
                                    }
                                 }
                              }

                              var48 += var58 + 1;
                              this.readLabel(var48, var42);
                              --var46;
                           } else {
                              var52 = null;
                           }
                        ...
                        var57 = var4[var12] & 255;
                        switch(ClassWriter.a[var57]) {
                        case 0:
                           var36.visitInsn(var57);
                           ++var12;
                           continue label620;
                        case 1:
                           var36.visitIntInsn(var57, var4[var12 + 1]);
                           var12 += 2;
                           continue label620;
                        case 2:
                           var36.visitIntInsn(var57, this.readShort(var12 + 1));
                           var12 += 3;
                           continue label620;
                        case 3:
                           var36.visitVarInsn(var57, var4[var12 + 1] & 255);
                           var12 += 2;
                           continue label620;
                        case 4:
                           if (var57 > 54) {
                              var57 -= 59;
                              var36.visitVarInsn(54 + (var57 >> 2), var57 & 3);
                           } else {
                              var57 -= 26;
                              var36.visitVarInsn(21 + (var57 >> 2), var57 & 3);
                           }

                           ++var12;
                           continue label620;
                        case 5:
                           var36.visitTypeInsn(var57, this.readClass(var12 + 1, var5));
                           var12 += 3;
                           continue label620;
                        case 6:
                        case 7:
                           int var63 = this.a[this.readUnsignedShort(var12 + 1)];
                           String var64;
                           if (var57 == 186) {
                              var64 = "java/lang/dyn/Dynamic";
                           } else {
                              var64 = this.readClass(var63, var5);
                              var63 = this.a[this.readUnsignedShort(var63 + 2)];
                           }

                           String var65 = this.readUTF8(var63, var5);
                           String var66 = this.readUTF8(var63 + 2, var5);
                           if (var57 < 182) {
                              var36.visitFieldInsn(var57, var64, var65, var66);
                           } else {
                              var36.visitMethodInsn(var57, var64, var65, var66);
                           }

                           if (var57 != 185 && var57 != 186) {
                              var12 += 3;
                              continue label620;
                           }
                           ...
                           continue label620;
                        case 8:
                           var36.visitJumpInsn(var57, var42[var15 + this.readShort(var12 + 1)]);
                           var12 += 3;
                           continue label620;
                        case 9:
                           var36.visitJumpInsn(var57 - 33, var42[var15 + this.readInt(var12 + 1)]);
                           var12 += 5;
                           continue label620;
                        case 10:
                        ...
                        case 13:
                           var12 = var12 + 4 - (var15 & 3);
                           var55 = var15 + this.readInt(var12);
                           var58 = this.readInt(var12 + 4);
                           var59 = this.readInt(var12 + 8);
                           var12 += 12;
                           Label[] var60 = new Label[var59 - var58 + 1];

                           for(var20 = 0; var20 < var60.length; ++var20) {
                              var60[var20] = var42[var15 + this.readInt(var12)];
                              var12 += 4;
                           }

                           var36.visitTableSwitchInsn(var58, var59, var42[var55], var60);
                           continue label620;
                        case 14:
                           var12 = var12 + 4 - (var15 & 3);
                           var55 = var15 + this.readInt(var12);
                           var20 = this.readInt(var12 + 4);
                           var12 += 8;
                           int[] var61 = new int[var20];
                           Label[] var62 = new Label[var20];

                           for(var20 = 0; var20 < var61.length; ++var20) {
                              var61[var20] = this.readInt(var12);
                              var62[var20] = var42[var15 + this.readInt(var12 + 4)];
                              var12 += 8;
                           }

                           var36.visitLookupSwitchInsn(var42[var55], var61, var62);
                           continue label620;
                        case 15:
                        default:
                           ...
                           continue label620;
                        case 16:
                           var57 = var4[var12 + 1] & 255;
                           if (var57 == 132) {
                              var36.visitIincInsn(this.readUnsignedShort(var12 + 2), this.readShort(var12 + 4));
                              var12 += 6;
                           } else {
                              var36.visitVarInsn(var57, this.readUnsignedShort(var12 + 2));
                              var12 += 4;
                           }
                           continue label620;
                        }
                  ...
                  if (!var18 && var43 != 0) {
                     int[] var75 = null;
                     if (var73 != 0) {
                        var32 = this.readUnsignedShort(var73) * 3;
                        var15 = var73 + 2;

                        for(var75 = new int[var32]; var32 > 0; var15 += 10) {
                           --var32;
                           var75[var32] = var15 + 6;
                           --var32;
                           var75[var32] = this.readUnsignedShort(var15 + 8);
                           --var32;
                           var75[var32] = this.readUnsignedShort(var15);
                        }
                     }
                     ...
                     for(var15 = var43 + 2; var32 > 0; --var32) {
                        var58 = this.readUnsignedShort(var15);
                        var59 = this.readUnsignedShort(var15 + 2);
                        int var76 = this.readUnsignedShort(var15 + 8);
                        String var78 = null;
                        if (var75 != null) {
                           for(int var79 = 0; var79 < var75.length; var79 += 3) {
                              if (var75[var79] == var58 && var75[var79 + 1] == var76) {
                                 var78 = this.readUTF8(var75[var79 + 2], var5);
                                 break;
                              }
                           }
                        }

                        var36.visitLocalVariable(this.readUTF8(var15 + 4, var5), this.readUTF8(var15 + 6, var5), var78, var42[var58], var42[var58 + var59], var76);
                        var15 += 10;
                     }
                  }
