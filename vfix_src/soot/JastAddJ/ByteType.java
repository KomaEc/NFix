...
public class ByteType extends IntegralType implements Cloneable {
   ...
   public ByteType(Modifiers p0, Symbol p1, Opt<Access> p2, List<BodyDecl> p3) {
      this.setChild(p0, 0);
      this.setID(p1);
      this.setChild(p2, 1);
      this.setChild(p3, 2);
   ...
   public Constant cast(Constant c) {
      ...
      return Constant.create((int)((byte)c.intValue()));
   }
   ...
   private TypeDecl boxed_compute() {
      return this.lookupType("java.lang", "Byte");
   }
