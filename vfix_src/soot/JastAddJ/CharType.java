...
public class CharType extends IntegralType implements Cloneable {
   ...
   public CharType(Modifiers p0, Symbol p1, Opt<Access> p2, List<BodyDecl> p3) {
      this.setChild(p0, 0);
      this.setID(p1);
      this.setChild(p2, 1);
      this.setChild(p3, 2);
   ...
   private TypeDecl boxed_compute() {
      return this.lookupType("java.lang", "Character");
   }
