...
public class PlaceholderMethodDecl extends GenericMethodDecl implements Cloneable {
   ...
   public PlaceholderMethodDecl copy() {
      try {
         PlaceholderMethodDecl node = this.clone();
         node.parent = null;
   ...
   public PlaceholderMethodDecl fullCopy() {
      PlaceholderMethodDecl tree = this.copy();
      if (this.children != null) {
   ...
   public PlaceholderMethodDecl(Modifiers p0, Access p1, Symbol p2, List<ParameterDeclaration> p3, List<Access> p4, Opt<Block> p5, List<TypeVariable> p6) {
      this.setChild(p0, 0);
      this.setChild(p1, 1);
      this.setID(p2);
      this.setChild(p3, 2);
