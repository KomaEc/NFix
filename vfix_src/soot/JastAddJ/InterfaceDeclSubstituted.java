...
public class InterfaceDeclSubstituted extends InterfaceDecl implements Cloneable, MemberSubstitutor {
   ...
   public InterfaceDeclSubstituted copy() {
      try {
         InterfaceDeclSubstituted node = this.clone();
         node.parent = null;
   ...
   public InterfaceDeclSubstituted fullCopy() {
      InterfaceDeclSubstituted tree = this.copy();
      if (this.children != null) {
   ...
   public boolean supertypeInterfaceDeclSubstituted(InterfaceDeclSubstituted type) {
      ASTNode$State state = this.state();
      return this.original() == type.original() && type.enclosingType().subtype(this.enclosingType()) || super.supertypeInterfaceDeclSubstituted(type);
   }

   public boolean supertypeInterfaceDecl(InterfaceDecl type) {
      ASTNode$State state = this.state();
      return super.supertypeInterfaceDecl(type) || this.original().supertypeInterfaceDecl(type);
   }
