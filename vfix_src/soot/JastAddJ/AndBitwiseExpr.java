...
public class AndBitwiseExpr extends BitwiseExpr implements Cloneable {
   ...
   public AndBitwiseExpr copy() {
      try {
         AndBitwiseExpr node = this.clone();
         node.parent = null;
   ...
   public Value emitOperation(Body b, Value left, Value right) {
      return this.asLocal(b, b.newAndExpr(this.asImmediate(b, left), this.asImmediate(b, right), this));
   }
   ...
   public Constant constant() {
      ...
      return this.type().andBitwise(this.getLeftOperand().constant(), this.getRightOperand().constant());
   }
