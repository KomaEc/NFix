...
public class ClassDeclSubstituted extends ClassDecl implements Cloneable, MemberSubstitutor {
   ...
   public ClassDeclSubstituted copy() {
      try {
         ClassDeclSubstituted node = this.clone();
         node.parent = null;
   ...
   public ClassDeclSubstituted fullCopy() {
      ClassDeclSubstituted tree = this.copy();
      if (this.children != null) {
   ...
   public boolean supertypeClassDeclSubstituted(ClassDeclSubstituted type) {
      ASTNode$State state = this.state();
      return this.original() == type.original() && type.enclosingType().subtype(this.enclosingType()) || super.supertypeClassDeclSubstituted(type);
   }

   public boolean supertypeClassDecl(ClassDecl type) {
      ASTNode$State state = this.state();
      return super.supertypeClassDecl(type) || this.original().supertypeClassDecl(type);
   }
