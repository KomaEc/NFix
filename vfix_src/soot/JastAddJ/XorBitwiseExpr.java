...
public class XorBitwiseExpr extends BitwiseExpr implements Cloneable {
   ...
   public XorBitwiseExpr copy() {
      try {
         XorBitwiseExpr node = this.clone();
         node.parent = null;
   ...
   public Value emitOperation(Body b, Value left, Value right) {
      return this.asLocal(b, b.newXorExpr(this.asImmediate(b, left), this.asImmediate(b, right), this));
   }
   ...
   public Constant constant() {
      ...
      return this.type().xorBitwise(this.getLeftOperand().constant(), this.getRightOperand().constant());
   }
