...
public class LongLiteral extends NumericLiteral implements Cloneable {
   ...
   public Value eval(Body b) {
      return LongConstant.v(this.constant().longValue());
   }
   ...
   public void typeCheck() {
      if (this.constant().error) {
         this.error("The integer literal \"" + this.getLITERAL() + "\" is too large for type long.");
      }
   ...
   private Constant constant_compute() {
      try {
         return Constant.create(this.parseLong());
