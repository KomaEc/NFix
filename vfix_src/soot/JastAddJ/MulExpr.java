...
public class MulExpr extends MultiplicativeExpr implements Cloneable {
   ...
   public Value emitOperation(Body b, Value left, Value right) {
      return this.asLocal(b, b.newMulExpr(this.asImmediate(b, left), this.asImmediate(b, right), this));
   }
   ...
   public Constant constant() {
      ...
      return this.type().mul(this.getLeftOperand().constant(), this.getRightOperand().constant());
   }
