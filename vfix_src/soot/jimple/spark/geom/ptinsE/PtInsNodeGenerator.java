...
public class PtInsNodeGenerator extends IEncodingBroker {
   ...
   public void initFlowGraph(GeomPointsTo ptAnalyzer) {
      int n_legal_cons = 0;
      Iterator var10 = ptAnalyzer.constraints.iterator();
      ...
      while(true) {
         ...
         switch(cons.type) {
         case 0:
            my_rhs.add_points_to_3((AllocNode)my_lhs.getWrappedNode(), nf2 == 0 ? 0L : 1L, nf1 == 0 ? 0L : 1L, nf2 == 0 ? ptAnalyzer.context_size[nf1] : ptAnalyzer.context_size[nf2]);
