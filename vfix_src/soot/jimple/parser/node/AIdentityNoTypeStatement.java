...
public final class AIdentityNoTypeStatement extends PStatement {
   ...
   public Object clone() {
      return new AIdentityNoTypeStatement((PLocalName)this.cloneNode(this._localName_), (TColonEquals)this.cloneNode(this._colonEquals_), (TAtIdentifier)this.cloneNode(this._atIdentifier_), (TSemicolon)this.cloneNode(this._semicolon_));
   }
   ...
   public String toString() {
      return "" + this.toString(this._localName_) + this.toString(this._colonEquals_) + this.toString(this._atIdentifier_) + this.toString(this._semicolon_);
   }
