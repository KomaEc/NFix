...
public final class ATableswitchStatement extends PStatement {
   ...
   public ATableswitchStatement(TTableswitch _tableswitch_, TLParen _lParen_, PImmediate _immediate_, TRParen _rParen_, TLBrace _lBrace_, List<?> _caseStmt_, TRBrace _rBrace_, TSemicolon _semicolon_) {
      this.setTableswitch(_tableswitch_);
   ...
   public Object clone() {
      return new ATableswitchStatement((TTableswitch)this.cloneNode(this._tableswitch_), (TLParen)this.cloneNode(this._lParen_), (PImmediate)this.cloneNode(this._immediate_), (TRParen)this.cloneNode(this._rParen_), (TLBrace)this.cloneNode(this._lBrace_), this.cloneList(this._caseStmt_), (TRBrace)this.cloneNode(this._rBrace_), (TSemicolon)this.cloneNode(this._semicolon_));
   }
   ...
   public void setTableswitch(TTableswitch node) {
      if (this._tableswitch_ != null) {
         this._tableswitch_.parent((Node)null);
      }
   ...
   public String toString() {
      return "" + this.toString(this._tableswitch_) + this.toString(this._lParen_) + this.toString(this._immediate_) + this.toString(this._rParen_) + this.toString(this._lBrace_) + this.toString(this._caseStmt_) + this.toString(this._rBrace_) + this.toString(this._semicolon_);
   }
   ...
   void replaceChild(Node oldChild, Node newChild) {
      if (this._tableswitch_ == oldChild) {
         this.setTableswitch((TTableswitch)newChild);
