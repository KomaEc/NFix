...
public final class AFixedArrayDescriptor extends PFixedArrayDescriptor {
   ...
   public AFixedArrayDescriptor(TLBracket _lBracket_, PImmediate _immediate_, TRBracket _rBracket_) {
   ...
   public Object clone() {
      return new AFixedArrayDescriptor((TLBracket)this.cloneNode(this._lBracket_), (PImmediate)this.cloneNode(this._immediate_), (TRBracket)this.cloneNode(this._rBracket_));
   }
