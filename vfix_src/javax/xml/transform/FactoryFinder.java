...
class FactoryFinder {
   ...
   private static ClassLoader findClassLoader() throws FactoryFinder.ConfigurationError {
      Method var0 = null;
      ...
      try {
         ...
         throw new FactoryFinder.ConfigurationError("Unexpected IllegalAccessException", var3);
      } catch (InvocationTargetException var4) {
         throw new FactoryFinder.ConfigurationError("Unexpected InvocationTargetException", var4);
      }
   }

   private static Object newInstance(String var0, ClassLoader var1) throws FactoryFinder.ConfigurationError {
      try {
         Class var2;
         if (var1 == null) {
         ...
         throw new FactoryFinder.ConfigurationError("Provider " + var0 + " not found", var4);
      } catch (Exception var5) {
         throw new FactoryFinder.ConfigurationError("Provider " + var0 + " could not be instantiated: " + var5, var5);
      }
   }

   static Object find(String var0, String var1) throws FactoryFinder.ConfigurationError {
      ...
      if (var1 == null) {
         throw new FactoryFinder.ConfigurationError("Provider for " + var0 + " cannot be found", (Exception)null);
      } else {
