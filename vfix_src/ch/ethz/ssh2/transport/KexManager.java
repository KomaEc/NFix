...
public class KexManager {
   ...
   static {
      ...
      if (var10000 == null) {
         try {
            var10000 = Class.forName("ch.ethz.ssh2.transport.KexManager");
         ...
         if (this.kxs.np.kex_algo.equals("diffie-hellman-group-exchange-sha1")) {
            if (this.kxs.state == 1) {
               ...
               if (this.verifier != null) {
                  ...
                  try {
                     ...
                     throw (IOException)(new IOException("The server hostkey was not accepted by the verifier callback.")).initCause(var12);
                  }
               ...
               try {
                  ...
                  throw (IOException)(new IOException("KEX error.")).initCause(var11);
               }
            ...
            if (this.verifier != null) {
               ...
               try {
                  ...
                  throw (IOException)(new IOException("The server hostkey was not accepted by the verifier callback.")).initCause(var14);
               }
            ...
            try {
               ...
               throw (IOException)(new IOException("KEX error.")).initCause(var13);
            }
