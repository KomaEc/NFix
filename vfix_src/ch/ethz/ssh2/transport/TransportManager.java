...
public class TransportManager {
   ...
   static {
      ...
      if (var10000 == null) {
         try {
            var10000 = Class.forName("ch.ethz.ssh2.transport.TransportManager");
      ...
      this.receiveThread = new Thread(new Runnable() {
         public void run() {
            ...
            for(int i = 0; i < TransportManager.this.messageHandlers.size(); ++i) {
               TransportManager.HandlerEntry he = (TransportManager.HandlerEntry)TransportManager.this.messageHandlers.elementAt(i);
   ...
   public void registerMessageHandler(MessageHandler mh, int low, int high) {
      TransportManager.HandlerEntry he = new TransportManager.HandlerEntry();
      he.mh = mh;
      he.low = low;
      he.high = high;
   ...
   public void removeMessageHandler(MessageHandler mh, int low, int high) {
      synchronized(this.messageHandlers) {
         for(int i = 0; i < this.messageHandlers.size(); ++i) {
            TransportManager.HandlerEntry he = (TransportManager.HandlerEntry)this.messageHandlers.elementAt(i);
      ...
      synchronized(this.asynchronousQueue) {
         ...
         if (this.asynchronousQueue.size() > 100) {
            ...
            if (this.asynchronousThread == null) {
               this.asynchronousThread = new TransportManager.AsynchronousWorker();
