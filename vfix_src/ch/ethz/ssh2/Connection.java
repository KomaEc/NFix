      ...
      if (this.tm != null) {
         ...
         try {
            ...
            try {
               ...
               throw (SocketTimeoutException)(new SocketTimeoutException("The connect() operation on the socket timed out.")).initCause(var11);
            }
            ...
            if (var14 instanceof HTTPProxyException) {
               throw var14;
            } else {
               throw (IOException)(new IOException("There was a problem while connecting to " + this.hostname + ":" + this.port)).initCause(var14);
            }
         }
      }
   }
