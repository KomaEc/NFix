...
public class KnownHosts {
      ...
      if (hostnames == null) {
         ...
         if ("ssh-rsa".equals(serverHostKeyAlgorithm)) {
            ...
            synchronized(this.publicKeys) {
               this.publicKeys.add(new KnownHosts.KnownHostsEntry(hostnames, rpk));
            }
         } else {
            ...
            synchronized(this.publicKeys) {
               this.publicKeys.add(new KnownHosts.KnownHostsEntry(hostnames, dpk));
            }
         }
   ...
   private int checkKey(String remoteHostname, Object remoteKey) {
      ...
      synchronized(this.publicKeys) {
         ...
         while(i.hasNext()) {
            KnownHosts.KnownHostsEntry ke = (KnownHosts.KnownHostsEntry)i.next();
   ...
   public String[] getPreferredServerHostkeyAlgorithmOrder(String hostname) {
      ...
      if (algos != null) {
         ...
         InetAddress[] ipAdresses = (InetAddress[])null;
