...
public class JmxBeanExportFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204301L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204301 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object nodeName, Object nodeArgs, Map nodeAttribs) {
      ...
      Object var10000 = var5[0].callSafe(nodeAttribs, (Object)"policy");
      if (!DefaultTypeTransformation.booleanUnbox(var10000)) {
         var10000 = var5[1].callSafe(nodeAttribs, (Object)"regPolicy");
         if (!DefaultTypeTransformation.booleanUnbox(var10000)) {
            var10000 = "replace";
         }
      }

      this.registrationPolicy = var10000;
      return (Object)ScriptBytecodeAdapter.castToType(ScriptBytecodeAdapter.createList(new Object[0]), $get$$class$java$lang$Object());
   }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$jmx$builder$JmxBeanExportFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$jmx$builder$JmxBeanExportFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$jmx$builder$JmxBeanExportFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   public void setRegistrationPolicy(Object var1) {
      this.registrationPolicy = var1;
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$jmx$builder$JmxBeanExportFactory(), var0);
   }
