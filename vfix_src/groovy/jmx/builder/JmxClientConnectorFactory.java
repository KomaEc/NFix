...
public class JmxClientConnectorFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204311L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204311 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object nodeName, Object nodeArgs, Map nodeAttribs) {
      ...
      if (DefaultTypeTransformation.booleanUnbox(nodeArgs)) {
         ...
         if (DefaultTypeTransformation.booleanUnbox(!DefaultTypeTransformation.booleanUnbox(port) && !DefaultTypeTransformation.booleanUnbox(url) ? Boolean.TRUE : Boolean.FALSE)) {
            throw (Throwable)var5[10].callConstructor($get$$class$groovy$jmx$builder$JmxBuilderException(), (Object)(new GStringImpl(new Object[]{nodeName}, new String[]{"Node '", " requires attribute 'port' to specify server's port number."})));
         } else if (!DefaultTypeTransformation.booleanUnbox(var5[11].call(SUPPORTED_PROTOCOLS, (Object)protocol))) {
            throw (Throwable)var5[12].callConstructor($get$$class$groovy$jmx$builder$JmxBuilderException(), (Object)var5[13].call(new GStringImpl(new Object[]{protocol}, new String[]{"Connector protocol '", " is not supported at this time. "}), (Object)(new GStringImpl(new Object[]{SUPPORTED_PROTOCOLS}, new String[]{"Supported protocols are ", "."}))));
         } else {
            JMXServiceURL serviceUrl = (JMXServiceURL)ScriptBytecodeAdapter.castToType(DefaultTypeTransformation.booleanUnbox(url) ? var5[14].callConstructor($get$$class$javax$management$remote$JMXServiceURL(), (Object)url) : var5[15].callCurrent(this, protocol, host, port), $get$$class$javax$management$remote$JMXServiceURL());
            JMXConnector connector = (JMXConnector)ScriptBytecodeAdapter.castToType(var5[16].call($get$$class$javax$management$remote$JMXConnectorFactory(), serviceUrl, props), $get$$class$javax$management$remote$JMXConnector());
   ...
   private JMXServiceURL generateServiceUrl(Object protocol, Object host, Object port) {
      ...
      return (JMXServiceURL)ScriptBytecodeAdapter.castToType(var4[17].callConstructor($get$$class$javax$management$remote$JMXServiceURL(), (Object)url), $get$$class$javax$management$remote$JMXServiceURL());
   }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$jmx$builder$JmxClientConnectorFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$jmx$builder$JmxClientConnectorFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$jmx$builder$JmxClientConnectorFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static void $createCallSiteArray_1(String[] var0) {
      ...
      var0[13] = "plus";
      var0[14] = "<$constructor$>";
      var0[15] = "generateServiceUrl";
      var0[16] = "newJMXConnector";
      var0[17] = "<$constructor$>";
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$jmx$builder$JmxClientConnectorFactory(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$javax$management$remote$JMXConnectorFactory() {
      Class var10000 = $class$javax$management$remote$JMXConnectorFactory;
      if (var10000 == null) {
         var10000 = $class$javax$management$remote$JMXConnectorFactory = class$("javax.management.remote.JMXConnectorFactory");
      }
   ...
   // $FF: synthetic method
   private static Class $get$$class$javax$management$remote$JMXConnector() {
      Class var10000 = $class$javax$management$remote$JMXConnector;
      if (var10000 == null) {
         var10000 = $class$javax$management$remote$JMXConnector = class$("javax.management.remote.JMXConnector");
      }
