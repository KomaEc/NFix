...
public class LineBorderFactory extends SwingBorderFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524205016L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524205016 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) {
      ...
      ScriptBytecodeAdapter.setProperty(var5[0].call(attributes, (Object)"parent"), $get$$class$groovy$swing$factory$LineBorderFactory(), var5[1].callGroovyObjectGetProperty(builder), "applyBorderToParent");
      Object color = var5[2].call(attributes, (Object)"color");
      if (ScriptBytecodeAdapter.compareEqual(color, (Object)null)) {
         throw (Throwable)var5[3].callConstructor($get$$class$java$lang$RuntimeException(), (Object)(new GStringImpl(new Object[]{name}, new String[]{"color: is a required attribute for ", ""})));
      } else {
         Object thickness = var5[4].call(attributes, (Object)"thickness");
         if (ScriptBytecodeAdapter.compareEqual(thickness, (Object)null)) {
            thickness = $const$0;
         }

         Object roundedCorners = var5[5].call(attributes, (Object)"roundedCorners");
         if (ScriptBytecodeAdapter.compareEqual(roundedCorners, (Object)null)) {
            roundedCorners = Boolean.FALSE;
         }

         if (DefaultTypeTransformation.booleanUnbox(attributes)) {
            throw (Throwable)var5[6].callConstructor($get$$class$java$lang$RuntimeException(), (Object)(new GStringImpl(new Object[]{name, var5[7].call(attributes)}, new String[]{"", " does not know how to handle the remaining attibutes: ", ""})));
         } else {
            return (Object)ScriptBytecodeAdapter.castToType(var5[8].callConstructor($get$$class$javax$swing$border$LineBorder(), color, thickness, roundedCorners), $get$$class$java$lang$Object());
         }
      }
   }
   ...
   public Object this$dist$invoke$4(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$LineBorderFactory();
   ...
   public void this$dist$set$4(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$LineBorderFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$4(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$LineBorderFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$LineBorderFactory(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$javax$swing$border$LineBorder() {
      Class var10000 = $class$javax$swing$border$LineBorder;
      if (var10000 == null) {
         var10000 = $class$javax$swing$border$LineBorder = class$("javax.swing.border.LineBorder");
      }
