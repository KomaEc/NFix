...
public class PropertyColumnFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204543L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204543 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
      ...
      Object current = var5[1].call(builder);
      if (current instanceof DefaultTableModel) {
         DefaultTableModel model = (DefaultTableModel)ScriptBytecodeAdapter.castToType(current, $get$$class$groovy$model$DefaultTableModel());
         String property = (String)ScriptBytecodeAdapter.castToType(var5[2].call(attributes, (Object)"propertyName"), $get$$class$java$lang$String());
         if (ScriptBytecodeAdapter.compareEqual(property, (Object)null)) {
            throw (Throwable)var5[3].callConstructor($get$$class$java$lang$IllegalArgumentException(), (Object)"Must specify a property for a propertyColumn");
         } else {
            Object header = var5[4].call(attributes, (Object)"header");
            if (ScriptBytecodeAdapter.compareEqual(header, (Object)null)) {
               header = "";
            }

            Class type = (Class)ScriptBytecodeAdapter.castToType(var5[5].call(attributes, (Object)"type"), $get$$class$java$lang$Class());
            if (ScriptBytecodeAdapter.compareEqual(type, (Object)null)) {
               type = (Class)ScriptBytecodeAdapter.castToType($get$$class$java$lang$Object(), $get$$class$java$lang$Class());
            }

            Boolean editable = (Boolean)ScriptBytecodeAdapter.castToType(var5[6].call(attributes, (Object)"editable"), $get$$class$java$lang$Boolean());
            if (ScriptBytecodeAdapter.compareEqual(editable, (Object)null)) {
               editable = (Boolean)ScriptBytecodeAdapter.castToType(var5[7].callGetProperty($get$$class$java$lang$Boolean()), $get$$class$java$lang$Boolean());
            }

            return (Object)ScriptBytecodeAdapter.castToType(var5[8].call(model, header, property, type, var5[9].call(editable)), $get$$class$java$lang$Object());
         }
      } else {
         throw (Throwable)var5[10].callConstructor($get$$class$java$lang$RuntimeException(), (Object)"propertyColumn must be a child of a tableModel");
      }
   }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$PropertyColumnFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$PropertyColumnFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$PropertyColumnFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$PropertyColumnFactory(), var0);
   }
