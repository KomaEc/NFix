...
public class HStrutFactory extends AbstractFactory implements GroovyObject {
   ...
   // $FF: synthetic field
   private static final Integer $const$0 = (Integer)6;
   // $FF: synthetic field
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204412L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204412 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
      ...
      var5[0].call($get$$class$groovy$util$FactoryBuilderSupport(), value, name, $get$$class$java$lang$Number());
      Object num = null;
      if (ScriptBytecodeAdapter.compareNotEqual(value, (Object)null)) {
         num = value;
      } else {
         num = var5[1].call(attributes, (Object)"width");
      }

      return num instanceof Number ? (Object)ScriptBytecodeAdapter.castToType(var5[2].call($get$$class$javax$swing$Box(), (Object)var5[3].call((Number)ScriptBytecodeAdapter.castToType(num, $get$$class$java$lang$Number()))), $get$$class$java$lang$Object()) : (Object)ScriptBytecodeAdapter.castToType(var5[4].call($get$$class$javax$swing$Box(), (Object)$const$0), $get$$class$java$lang$Object());
   }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$HStrutFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$HStrutFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$HStrutFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static void $createCallSiteArray_1(String[] var0) {
      ...
      var0[1] = "remove";
      var0[2] = "createHorizontalStrut";
      var0[3] = "intValue";
      var0[4] = "createHorizontalStrut";
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$HStrutFactory(), var0);
   }
