...
public abstract class SwingBorderFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204530L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204530 = (Long)0L;
   // $FF: synthetic field
   ...
   public void setParent(FactoryBuilderSupport builder, Object parent, Object child) {
      CallSite[] var4 = $getCallSiteArray();
      if (DefaultTypeTransformation.booleanUnbox(var4[0].callGetProperty(var4[1].callGroovyObjectGetProperty(builder)))) {
         if (parent instanceof JComponent) {
            var4[2].call(parent, child);
         } else {
            if (!(parent instanceof RootPaneContainer)) {
               throw (Throwable)var4[5].callConstructor($get$$class$java$lang$RuntimeException(), (Object)"Border cannot be applied to parent, it is neither a JComponent or a RootPaneContainer");
            }

            var4[3].callCurrent(this, builder, var4[4].callGetProperty(parent), child);
         }
      }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$SwingBorderFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$SwingBorderFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$SwingBorderFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$SwingBorderFactory(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$groovy$swing$factory$SwingBorderFactory() {
      Class var10000 = $class$groovy$swing$factory$SwingBorderFactory;
      if (var10000 == null) {
         var10000 = $class$groovy$swing$factory$SwingBorderFactory = class$("groovy.swing.factory.SwingBorderFactory");
      }
