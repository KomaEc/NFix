...
public class ClosureColumnFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204545L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204545 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
      ...
      if (current instanceof DefaultTableModel) {
         ...
         Object header = var5[2].call(attributes, (Object)"header");
         if (ScriptBytecodeAdapter.compareEqual(header, (Object)null)) {
            header = "";
         }

         Closure readClosure = (Closure)ScriptBytecodeAdapter.castToType(var5[3].call(attributes, (Object)"read"), $get$$class$groovy$lang$Closure());
         if (ScriptBytecodeAdapter.compareEqual(readClosure, (Object)null)) {
            throw (Throwable)var5[4].callConstructor($get$$class$java$lang$IllegalArgumentException(), (Object)"Must specify 'read' Closure property for a closureColumn");
         } else {
            Closure writeClosure = (Closure)ScriptBytecodeAdapter.castToType(var5[5].call(attributes, (Object)"write"), $get$$class$groovy$lang$Closure());
            Class type = (Class)ScriptBytecodeAdapter.castToType(var5[6].call(attributes, (Object)"type"), $get$$class$java$lang$Class());
            ...
            return (Object)ScriptBytecodeAdapter.castToType(var5[7].call(model, header, readClosure, writeClosure, type), $get$$class$java$lang$Object());
         }
      } else {
         throw (Throwable)var5[8].callConstructor($get$$class$java$lang$RuntimeException(), (Object)"closureColumn must be a child of a tableModel");
      }
   }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$ClosureColumnFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$ClosureColumnFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$ClosureColumnFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$ClosureColumnFactory(), var0);
   }
