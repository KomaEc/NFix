...
public class CellEditorFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204425L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204425 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) {
      ...
      return (Object)ScriptBytecodeAdapter.castToType(var5[1].callConstructor($get$$class$groovy$swing$impl$ClosureCellEditor(), (Object)null, attributes), $get$$class$java$lang$Object());
   }

   public void setChild(FactoryBuilderSupport builder, Object parent, Object child) {
      CallSite[] var4 = $getCallSiteArray();
      if (child instanceof Component) {
         ScriptBytecodeAdapter.setProperty(var4[2].call(var4[3].callGetProperty(parent), child), $get$$class$groovy$swing$factory$CellEditorFactory(), parent, "children");
      }
   ...
   public void onNodeCompleted(FactoryBuilderSupport builder, Object parent, Object node) {
      CallSite[] var4 = $getCallSiteArray();
      ScriptBytecodeAdapter.setProperty(var4[4].callGetProperty(var4[5].callGroovyObjectGetProperty(builder)), $get$$class$groovy$swing$factory$CellEditorFactory(), node, "editorValue");
      ScriptBytecodeAdapter.setProperty(var4[6].callGetProperty(var4[7].callGroovyObjectGetProperty(builder)), $get$$class$groovy$swing$factory$CellEditorFactory(), node, "prepareEditor");
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$CellEditorFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$CellEditorFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$CellEditorFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static void $createCallSiteArray_1(String[] var0) {
      ...
      var0[2] = "plus";
      var0[3] = "children";
      var0[4] = "editorValueClosure";
      var0[5] = "context";
      var0[6] = "prepareEditorClosure";
      var0[7] = "context";
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$CellEditorFactory(), var0);
   }
