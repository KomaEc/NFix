...
public class TableLayoutFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204532L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204532 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
      ...
      return DefaultTypeTransformation.booleanUnbox(var5[0].call($get$$class$groovy$util$FactoryBuilderSupport(), value, name, $get$$class$groovy$swing$impl$TableLayout())) ? (Object)ScriptBytecodeAdapter.castToType(value, $get$$class$java$lang$Object()) : (Object)ScriptBytecodeAdapter.castToType(var5[1].callConstructor($get$$class$groovy$swing$impl$TableLayout()), $get$$class$java$lang$Object());
   }

   public void setParent(FactoryBuilderSupport builder, Object parent, Object child) {
      CallSite[] var4 = $getCallSiteArray();
      if (DefaultTypeTransformation.booleanUnbox(var4[2].call(builder))) {
         var4[3].call(var4[4].call(builder), builder, parent, var4[5].call(child));
      }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$TableLayoutFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$TableLayoutFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$TableLayoutFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static void $createCallSiteArray_1(String[] var0) {
      ...
      var0[1] = "<$constructor$>";
      var0[2] = "getParentFactory";
      var0[3] = "setChild";
      var0[4] = "getParentFactory";
      var0[5] = "getComponent";
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$TableLayoutFactory(), var0);
   }
