...
public class FormattedTextFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204463L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204463 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
      ...
      JFormattedTextField ftf = (JFormattedTextField)ScriptBytecodeAdapter.castToType((Object)null, $get$$class$javax$swing$JFormattedTextField());
      Object ftf;
      if (DefaultTypeTransformation.booleanUnbox(var5[1].call(attributes, (Object)"format"))) {
         ftf = var5[2].callConstructor($get$$class$javax$swing$JFormattedTextField(), (Object)ScriptBytecodeAdapter.createPojoWrapper((Format)ScriptBytecodeAdapter.castToType(var5[3].call(attributes, (Object)"format"), $get$$class$java$text$Format()), $get$$class$java$text$Format()));
      } else if (DefaultTypeTransformation.booleanUnbox(var5[4].call(attributes, (Object)"value"))) {
         ftf = var5[5].callConstructor($get$$class$javax$swing$JFormattedTextField(), (Object)var5[6].call(attributes, (Object)"value"));
      } else {
         ftf = var5[7].callConstructor($get$$class$javax$swing$JFormattedTextField());
      }

      return (Object)ScriptBytecodeAdapter.castToType(ftf, $get$$class$java$lang$Object());
   }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$FormattedTextFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$FormattedTextFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$FormattedTextFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$FormattedTextFactory(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$java$text$Format() {
      Class var10000 = $class$java$text$Format;
      if (var10000 == null) {
         var10000 = $class$java$text$Format = class$("java.text.Format");
      }
   ...
   // $FF: synthetic method
   private static Class $get$$class$javax$swing$JFormattedTextField() {
      Class var10000 = $class$javax$swing$JFormattedTextField;
      if (var10000 == null) {
         var10000 = $class$javax$swing$JFormattedTextField = class$("javax.swing.JFormattedTextField");
      }
