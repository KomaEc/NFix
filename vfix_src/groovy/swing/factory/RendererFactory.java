...
public class RendererFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204494L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204494 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) {
      ...
      return (Object)ScriptBytecodeAdapter.castToType(var5[1].callConstructor($get$$class$groovy$swing$impl$ClosureRenderer()), $get$$class$java$lang$Object());
   }

   public void setChild(FactoryBuilderSupport builder, Object parent, Object child) {
      CallSite[] var4 = $getCallSiteArray();
      if (child instanceof Component) {
         ScriptBytecodeAdapter.setProperty(var4[2].call(var4[3].callGetProperty(parent), child), $get$$class$groovy$swing$factory$RendererFactory(), parent, "children");
      }
   ...
   public void onNodeCompleted(FactoryBuilderSupport builder, Object parent, Object node) {
      CallSite[] var4 = $getCallSiteArray();
      ScriptBytecodeAdapter.setProperty(var4[4].callGetProperty(var4[5].callGroovyObjectGetProperty(builder)), $get$$class$groovy$swing$factory$RendererFactory(), node, "update");
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$RendererFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$RendererFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$RendererFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$RendererFactory(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$groovy$swing$impl$ClosureRenderer() {
      Class var10000 = $class$groovy$swing$impl$ClosureRenderer;
      if (var10000 == null) {
         var10000 = $class$groovy$swing$impl$ClosureRenderer = class$("groovy.swing.impl.ClosureRenderer");
      }
