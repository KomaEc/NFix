...
public class ComboBoxFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204461L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204461 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
      ...
      var5[0].call($get$$class$groovy$util$FactoryBuilderSupport(), value, name, $get$$class$javax$swing$JComboBox());
      Object items = var5[1].call(attributes, (Object)"items");
      JComboBox comboBox = (JComboBox)ScriptBytecodeAdapter.castToType((Object)null, $get$$class$javax$swing$JComboBox());
      Object comboBox;
      if (items instanceof Vector) {
         comboBox = var5[2].callConstructor($get$$class$javax$swing$JComboBox(), (Object)var5[3].call(attributes, (Object)"items"));
      } else if (items instanceof List) {
         List list = (List)ScriptBytecodeAdapter.castToType(var5[4].call(attributes, (Object)"items"), $get$$class$java$util$List());
         comboBox = var5[5].callConstructor($get$$class$javax$swing$JComboBox(), (Object)var5[6].call(list));
      } else if (items instanceof Object[]) {
         comboBox = var5[7].callConstructor($get$$class$javax$swing$JComboBox(), (Object)var5[8].call(attributes, (Object)"items"));
      } else if (value instanceof JComboBox) {
         comboBox = (JComboBox)ScriptBytecodeAdapter.castToType(value, $get$$class$javax$swing$JComboBox());
      } else {
         comboBox = var5[9].callConstructor($get$$class$javax$swing$JComboBox());
      }

      var5[10].call($get$$class$groovy$swing$binding$JComboBoxMetaMethods(), (Object)comboBox);
      return (Object)ScriptBytecodeAdapter.castToType(comboBox, $get$$class$java$lang$Object());
   }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$ComboBoxFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$ComboBoxFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$ComboBoxFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$ComboBoxFactory(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$javax$swing$JComboBox() {
      Class var10000 = $class$javax$swing$JComboBox;
      if (var10000 == null) {
         var10000 = $class$javax$swing$JComboBox = class$("javax.swing.JComboBox");
      }
