...
public class BindGroupFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204395L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204395 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) {
      ...
      AggregateBinding bindGroup = var5[0].callConstructor($get$$class$org$codehaus$groovy$binding$AggregateBinding());
      Object bind = var5[1].call(attributes, (Object)"bind");
      if (DefaultTypeTransformation.booleanUnbox(!ScriptBytecodeAdapter.compareEqual(bind, (Object)null) && !DefaultTypeTransformation.booleanUnbox(bind) ? Boolean.FALSE : Boolean.TRUE)) {
         var5[2].call(bindGroup);
      }

      return (Object)ScriptBytecodeAdapter.castToType(bindGroup, $get$$class$java$lang$Object());
   }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$BindGroupFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$BindGroupFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$BindGroupFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$BindGroupFactory(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$org$codehaus$groovy$binding$AggregateBinding() {
      Class var10000 = $class$org$codehaus$groovy$binding$AggregateBinding;
      if (var10000 == null) {
         var10000 = $class$org$codehaus$groovy$binding$AggregateBinding = class$("org.codehaus.groovy.binding.AggregateBinding");
      }
