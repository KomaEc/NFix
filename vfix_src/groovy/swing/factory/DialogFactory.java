...
public class DialogFactory extends RootPaneContainerFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204976L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204976 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
      ...
      JDialog dialog = (JDialog)ScriptBytecodeAdapter.castToType((Object)null, $get$$class$javax$swing$JDialog());
      Object dialog;
      if (DefaultTypeTransformation.booleanUnbox(var5[0].call($get$$class$groovy$util$FactoryBuilderSupport(), value, name, $get$$class$javax$swing$JDialog()))) {
         dialog = (JDialog)ScriptBytecodeAdapter.castToType(value, $get$$class$javax$swing$JDialog());
      } else {
         Object owner = var5[1].call(attributes, (Object)"owner");
         LinkedList containingWindows = (LinkedList)ScriptBytecodeAdapter.castToType(var5[2].callGroovyObjectGetProperty(builder), $get$$class$java$util$LinkedList());
         if (DefaultTypeTransformation.booleanUnbox(ScriptBytecodeAdapter.compareEqual(owner, (Object)null) && !DefaultTypeTransformation.booleanUnbox(var5[3].call(containingWindows)) ? Boolean.TRUE : Boolean.FALSE)) {
            owner = var5[4].call(containingWindows);
         }

         if (owner instanceof Frame) {
            dialog = var5[5].callConstructor($get$$class$javax$swing$JDialog(), (Object)ScriptBytecodeAdapter.createPojoWrapper((Frame)ScriptBytecodeAdapter.castToType(owner, $get$$class$java$awt$Frame()), $get$$class$java$awt$Frame()));
         } else if (owner instanceof Dialog) {
            dialog = var5[6].callConstructor($get$$class$javax$swing$JDialog(), (Object)ScriptBytecodeAdapter.createPojoWrapper((Dialog)ScriptBytecodeAdapter.castToType(owner, $get$$class$java$awt$Dialog()), $get$$class$java$awt$Dialog()));
         } else {
            dialog = var5[7].callConstructor($get$$class$javax$swing$JDialog());
         }
      }

      var5[8].callCurrent(this, builder, dialog, attributes);
      return (Object)ScriptBytecodeAdapter.castToType(dialog, $get$$class$java$lang$Object());
   }
   ...
   public Object this$dist$invoke$4(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$DialogFactory();
   ...
   public void this$dist$set$4(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$DialogFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$4(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$DialogFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static void $createCallSiteArray_1(String[] var0) {
      ...
      var0[1] = "remove";
      var0[2] = "containingWindows";
      var0[3] = "isEmpty";
      var0[4] = "getLast";
      var0[5] = "<$constructor$>";
      var0[6] = "<$constructor$>";
      var0[7] = "<$constructor$>";
      var0[8] = "handleRootPaneTasks";
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$DialogFactory(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$java$awt$Dialog() {
      Class var10000 = $class$java$awt$Dialog;
      if (var10000 == null) {
         var10000 = $class$java$awt$Dialog = class$("java.awt.Dialog");
      }
