...
public class CellEditorGetValueFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204428L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204428 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) {
      ...
      return (Object)ScriptBytecodeAdapter.castToType(var5[0].call($get$$class$java$util$Collections()), $get$$class$java$lang$Object());
   }
   ...
   public boolean onNodeChildren(FactoryBuilderSupport builder, Object node, Closure childContent) {
      ...
      ScriptBytecodeAdapter.setProperty(childContent, $get$$class$groovy$swing$factory$CellEditorGetValueFactory(), var4[1].callGroovyObjectGetProperty(builder), "editorValueClosure");
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$CellEditorGetValueFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$CellEditorGetValueFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$CellEditorGetValueFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$CellEditorGetValueFactory(), var0);
   }
