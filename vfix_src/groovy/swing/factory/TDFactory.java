...
public class TDFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204536L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204536 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
      ...
      if (parent instanceof TableLayoutRow) {
         return (Object)ScriptBytecodeAdapter.castToType(var5[2].callConstructor($get$$class$groovy$swing$impl$TableLayoutCell(), (Object)ScriptBytecodeAdapter.createPojoWrapper((TableLayoutRow)ScriptBytecodeAdapter.castToType(parent, $get$$class$groovy$swing$impl$TableLayoutRow()), $get$$class$groovy$swing$impl$TableLayoutRow())), $get$$class$java$lang$Object());
      } else {
         throw (Throwable)var5[3].callConstructor($get$$class$java$lang$RuntimeException(), (Object)"'td' must be within a 'tr'");
      }
   }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$TDFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$TDFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$TDFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$TDFactory(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$groovy$swing$impl$TableLayoutCell() {
      Class var10000 = $class$groovy$swing$impl$TableLayoutCell;
      if (var10000 == null) {
         var10000 = $class$groovy$swing$impl$TableLayoutCell = class$("groovy.swing.impl.TableLayoutCell");
      }
