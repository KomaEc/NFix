...
public class SeparatorFactory extends AbstractFactory implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204506L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204506 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object newInstance(FactoryBuilderSupport builder, Object name, Object value, Map attributes) throws InstantiationException, IllegalAccessException {
      ...
      if (parent instanceof JMenu) {
         return (Object)ScriptBytecodeAdapter.castToType(var5[2].callConstructor($get$$class$javax$swing$JPopupMenu$Separator()), $get$$class$java$lang$Object());
      } else {
         return parent instanceof JToolBar ? (Object)ScriptBytecodeAdapter.castToType(var5[3].callConstructor($get$$class$javax$swing$JToolBar$Separator()), $get$$class$java$lang$Object()) : (Object)ScriptBytecodeAdapter.castToType(var5[4].callConstructor($get$$class$javax$swing$JSeparator()), $get$$class$java$lang$Object());
      }
   }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$groovy$swing$factory$SeparatorFactory();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$factory$SeparatorFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$factory$SeparatorFactory(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$factory$SeparatorFactory(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$javax$swing$JSeparator() {
      Class var10000 = $class$javax$swing$JSeparator;
      if (var10000 == null) {
         var10000 = $class$javax$swing$JSeparator = class$("javax.swing.JSeparator");
      }
   ...
   // $FF: synthetic method
   private static Class $get$$class$javax$swing$JPopupMenu$Separator() {
      Class var10000 = $class$javax$swing$JPopupMenu$Separator;
      if (var10000 == null) {
         var10000 = $class$javax$swing$JPopupMenu$Separator = class$("javax.swing.JPopupMenu$Separator");
      }
   ...
   // $FF: synthetic method
   private static Class $get$$class$javax$swing$JToolBar$Separator() {
      Class var10000 = $class$javax$swing$JToolBar$Separator;
      if (var10000 == null) {
         var10000 = $class$javax$swing$JToolBar$Separator = class$("javax.swing.JToolBar$Separator");
      }
