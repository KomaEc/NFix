...
public class JListProperties$7 implements TriggerBinding, GroovyObject {
   ...
   // $FF: synthetic field
   private static Class $class$groovy$swing$binding$JListElementsBinding;
   // $FF: synthetic field
   ...
   public FullBinding createBinding(SourceBinding source, TargetBinding target) {
      ...
      return (FullBinding)ScriptBytecodeAdapter.castToType(var5[0].callConstructor($get$$class$groovy$swing$binding$JListElementsBinding(), ScriptBytecodeAdapter.createPojoWrapper((PropertyBinding)ScriptBytecodeAdapter.castToType(source.get(), $get$$class$org$codehaus$groovy$binding$PropertyBinding()), $get$$class$org$codehaus$groovy$binding$PropertyBinding()), target.get()), $get$$class$org$codehaus$groovy$binding$FullBinding());
   }

   // $FF: synthetic method
   public Object this$dist$invoke$3(String name, Object args) {
      CallSite[] var3 = $getCallSiteArray();
      Class var10000 = $get$$class$groovy$swing$binding$JListProperties$7();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$binding$JListProperties$7(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$binding$JListProperties$7(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   public void propertyMissing(String name, Object val) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setField(val, $get$$class$groovy$swing$binding$JListProperties$7(), $get$$class$groovy$swing$binding$JListProperties(), (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object propertyMissing(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getField($get$$class$groovy$swing$binding$JListProperties$7(), $get$$class$groovy$swing$binding$JListProperties(), (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$binding$JListProperties$7(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$groovy$swing$binding$JListElementsBinding() {
      Class var10000 = $class$groovy$swing$binding$JListElementsBinding;
      if (var10000 == null) {
         var10000 = $class$groovy$swing$binding$JListElementsBinding = class$("groovy.swing.binding.JListElementsBinding");
      }
