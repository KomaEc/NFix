...
public class JListElementsBinding extends AbstractSyntheticBinding implements ListDataListener, PropertyChangeListener, GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204935L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204935 = (Long)0L;
   // $FF: synthetic field
   ...
   public JListElementsBinding(PropertyBinding propertyBinding, TargetBinding target) {
      ...
      Object[] var10000 = new Object[]{propertyBinding, target, $get$$class$javax$swing$JList(), "elements"};
   ...
   protected void syntheticBind() {
      ...
      var1[2].call(this.boundList, "model", this);
      var1[3].call(var1[4].call(this.boundList), (Object)this);
   }

   protected void syntheticUnbind() {
      CallSite[] var1 = $getCallSiteArray();
      var1[5].call(this.boundList, "model", this);
      var1[6].call(var1[7].call(this.boundList), (Object)this);
   }

   public void propertyChange(PropertyChangeEvent event) {
      CallSite[] var2 = $getCallSiteArray();
      var2[8].callCurrent(this);
      var2[9].call((ListModel)ScriptBytecodeAdapter.castToType(var2[10].call(event), $get$$class$javax$swing$ListModel()), (Object)this);
      var2[11].call((ListModel)ScriptBytecodeAdapter.castToType(var2[12].call(event), $get$$class$javax$swing$ListModel()), (Object)this);
   }

   public void intervalAdded(ListDataEvent e) {
      CallSite[] var2 = $getCallSiteArray();
      var2[13].callCurrent(this);
   }
   ...
   public Object this$dist$invoke$4(String name, Object args) {
      CallSite[] var3 = $getCallSiteArray();
      Class var10000 = $get$$class$groovy$swing$binding$JListElementsBinding();
   ...
   public void this$dist$set$4(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$binding$JListElementsBinding(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$4(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$binding$JListElementsBinding(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static void $createCallSiteArray_1(String[] var0) {
      ...
      var0[3] = "addListDataListener";
      var0[4] = "getModel";
      var0[5] = "removePropertyChangeListener";
      var0[6] = "removeListDataListener";
      var0[7] = "getModel";
      var0[8] = "update";
      var0[9] = "removeListDataListener";
      var0[10] = "getOldValue";
      var0[11] = "addListDataListener";
      var0[12] = "getNewValue";
      var0[13] = "update";
      var0[14] = "update";
      var0[15] = "update";
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$binding$JListElementsBinding(), var0);
   }
