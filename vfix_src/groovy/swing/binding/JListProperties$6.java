...
public class JListProperties$6 implements TriggerBinding, GroovyObject {
   ...
   public FullBinding createBinding(SourceBinding source, TargetBinding target) {
      ...
      return (FullBinding)ScriptBytecodeAdapter.castToType(var5[0].callConstructor($get$$class$groovy$swing$binding$JListSelectedElementBinding(), ScriptBytecodeAdapter.createPojoWrapper((PropertyBinding)ScriptBytecodeAdapter.castToType(source.get(), $get$$class$org$codehaus$groovy$binding$PropertyBinding()), $get$$class$org$codehaus$groovy$binding$PropertyBinding()), target.get(), "selectedIndices"), $get$$class$org$codehaus$groovy$binding$FullBinding());
   }

   // $FF: synthetic method
   public Object this$dist$invoke$3(String name, Object args) {
      CallSite[] var3 = $getCallSiteArray();
      Class var10000 = $get$$class$groovy$swing$binding$JListProperties$6();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$swing$binding$JListProperties$6(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$swing$binding$JListProperties$6(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   public void propertyMissing(String name, Object val) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setField(val, $get$$class$groovy$swing$binding$JListProperties$6(), $get$$class$groovy$swing$binding$JListProperties(), (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object propertyMissing(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getField($get$$class$groovy$swing$binding$JListProperties$6(), $get$$class$groovy$swing$binding$JListProperties(), (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$swing$binding$JListProperties$6(), var0);
   }
