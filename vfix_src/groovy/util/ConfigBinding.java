...
public class ConfigBinding extends Binding {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524205401L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524205401 = (Long)0L;
   // $FF: synthetic field
   ...
   protected MetaClass $getStaticMetaClass() {
      if (this.getClass() == $get$$class$groovy$util$ConfigBinding()) {
   ...
   public Object this$dist$invoke$4(String name, Object args) {
      CallSite[] var3 = $getCallSiteArray();
      Class var10000 = $get$$class$groovy$util$ConfigBinding();
   ...
   public void this$dist$set$4(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$groovy$util$ConfigBinding(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$4(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$groovy$util$ConfigBinding(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   public void setCallable(Object var1) {
      this.callable = var1;
   }
   ...
   // $FF: synthetic method
   public void super$3$setVariable(String var1, Object var2) {
   ...
   // $FF: synthetic method
   public Map super$3$getVariables() {
      return super.getVariables();
   }

   // $FF: synthetic method
   public Object super$3$getVariable(String var1) {
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$util$ConfigBinding(), var0);
   }
