...
private static class OutputTransforms$ObjectHolder_localTransforms implements GroovyObject {
   private static final Object INSTANCE = $getCallSiteArray()[0].callStatic($get$$class$groovy$ui$OutputTransforms());
   // $FF: synthetic field
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$groovy$ui$OutputTransforms$ObjectHolder_localTransforms(), var0);
   }
