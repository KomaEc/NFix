...
public class JavaSkipThree {
   public static void patch(JavaNode node) throws FileNotFoundException {
      ...
      JavaOperationLib.insertNullCheckReturn(body, node.getStatement(), node.getETwo(), node.getVFGNode().getMethod().getReturnType(), node.getNewClsName());
