...
public class NamespaceSupport {
   ...
   public void pushContext() {
      ...
      if (this.contextPos >= var1) {
         NamespaceSupport.Context[] var2 = new NamespaceSupport.Context[var1 * 2];
   ...
   final class Context {
      ...
      void setParent(NamespaceSupport.Context var1) {
         this.parent = var1;
      ...
      String[] processName(String var1, boolean var2) {
         ...
         Hashtable var3;
         if (var2) {
            var3 = this.attributeNameTable;
         } else {
            var3 = this.elementNameTable;
         }
         ...
         if (var4 != null) {
            ...
            var4 = new String[]{null, null, var1.intern()};
            int var5 = var1.indexOf(58);
            if (var5 == -1) {
               if (!var2 && this.defaultNS != null) {
                  var4[0] = this.defaultNS;
               } else {
                  var4[0] = "";
               }
