      ...
      if (!this.namespaces) {
         ...
         for(int var5 = 0; var5 < var4; ++var5) {
            ...
            if (var6.startsWith("xmlns")) {
               ...
               if (!this.nsSupport.declarePrefix(var8, var9)) {
                  this.reportError("Illegal Namespace prefix: " + var8);
               } else if (this.contentHandler != null) {
                  this.contentHandler.startPrefixMapping(var8, var9);
               }
            }
         }
         ...
         for(int var13 = 0; var13 < var4; ++var13) {
            var8 = var2.getName(var13);
            String var14 = var2.getType(var13);
            var9 = var2.getValue(var13);
            if (var8.startsWith("xmlns")) {
               int var10 = var8.indexOf(58);
               String var11;
               if (var10 == -1 && var8.length() == 5) {
                  var11 = "";
               } else if (var10 != 5) {
                  var11 = null;
               } else {
                  var11 = var8.substring(var10 + 1);
               }

               if (var11 != null) {
                  if (this.prefixes) {
                     this.atts.addAttribute("", "", var8.intern(), var14, var9);
                  }
                  continue;
               }
            }
            ...
            try {
               String[] var17 = this.processName(var8, true, true);
               ...
               this.atts.addAttribute("", var8, var8, var14, var9);
            }
         }
