...
public class SuiteGenerator {
   ...
   /** @deprecated */
   @Deprecated
   public static LaunchSuite createCustomizedSuite(String projectName, Collection<String> packageNames, Collection<String> classNames, Collection<String> methodNames, Collection<String> groupNames, Map<String, String> parameters, String annotationType, int logLevel) {
      if (null != groupNames && !groupNames.isEmpty()) {
         return new LaunchSuite.ClassListSuite(projectName, packageNames, classNames, groupNames, parameters, annotationType, logLevel);
      } else {
         return (LaunchSuite)((classNames == null || classNames.size() <= 1) && (packageNames == null || packageNames.size() <= 0) ? new LaunchSuite.MethodsSuite(projectName, (String)classNames.iterator().next(), methodNames, parameters, annotationType, logLevel) : new LaunchSuite.ClassListSuite(projectName, packageNames, classNames, groupNames, parameters, annotationType, logLevel));
      }
   }
}
