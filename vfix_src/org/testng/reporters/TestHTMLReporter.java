...
public class TestHTMLReporter extends TestListenerAdapter {
   private static final Comparator<ITestResult> NAME_COMPARATOR = new TestHTMLReporter.NameComparator();
   private static final Comparator<ITestResult> CONFIGURATION_COMPARATOR = new TestHTMLReporter.ConfigurationComparator();
   ...
   public static void generateTable(StringBuffer sb, String title, Collection<ITestResult> tests, String cssClass, Comparator<ITestResult> comparator) {
      ...
      while(i$.hasNext()) {
         ...
         sb.append("<td title='").append(tr.getTestClass().getName()).append(".").append(name).append("()'>").append("<b>").append(name).append("</b>");
   ...
   private static class ConfigurationComparator implements Comparator<ITestResult>, Serializable {
      ...
      // $FF: synthetic method
      ConfigurationComparator(Object x0) {
         this();
      }
   }
