...
public class DirectoryWalker {
   ...
   private void fireStep(File file) {
      DirectoryWalker.DirStackEntry dsEntry = (DirectoryWalker.DirStackEntry)this.dirStack.peek();
   ...
   private void scanDir(File dir) {
      ...
      if (files != null) {
         ...
         if (this.dirStack.isEmpty()) {
            ...
            DirectoryWalker.DirStackEntry previousStackEntry = (DirectoryWalker.DirStackEntry)this.dirStack.peek();
