...
public class AnsiDetector implements Callable<Boolean>, GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204024L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204024 = (Long)0L;
   // $FF: synthetic field
   ...
   public Boolean call() throws Exception {
      CallSite[] var1 = $getCallSiteArray();
      return (Boolean)ScriptBytecodeAdapter.castToType(var1[0].call(var1[1].call($get$$class$jline$Terminal())), $get$$class$java$lang$Boolean());
   }
   ...
   public Object this$dist$invoke$2(String name, Object args) {
      ...
      Class var10000 = $get$$class$org$codehaus$groovy$tools$shell$AnsiDetector();
   ...
   public void this$dist$set$2(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$org$codehaus$groovy$tools$shell$AnsiDetector(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$2(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$org$codehaus$groovy$tools$shell$AnsiDetector(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$org$codehaus$groovy$tools$shell$AnsiDetector(), var0);
   }
