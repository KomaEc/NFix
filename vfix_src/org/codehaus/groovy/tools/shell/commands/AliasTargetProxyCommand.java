...
public class AliasTargetProxyCommand extends CommandSupport {
   private static int counter = DefaultTypeTransformation.intUnbox(0);
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204791L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204791 = (Long)0L;
   // $FF: synthetic field
   private static SoftReference $callSiteArray;
   // $FF: synthetic field
   private static Class $class$groovy$lang$MetaClass;
   // $FF: synthetic field
   private static Class $class$org$codehaus$groovy$tools$shell$commands$AliasTargetProxyCommand;
   // $FF: synthetic field
   ...
   public AliasTargetProxyCommand(Shell shell, String name, List args) {
      ...
      Object[] var10000 = new Object[]{shell, name, null};
      CallSite var10003 = var4[0];
      Object var5 = DefaultTypeTransformation.box(counter);
      counter = DefaultTypeTransformation.intUnbox(var4[1].call(DefaultTypeTransformation.box(counter)));
      var10000[2] = var10003.call("\\a", (Object)var5);
      ...
      case 0:
         ...
         try {
            if (DefaultTypeTransformation.booleanUnbox(var6.record(args, 8))) {
               var6.clear();
            } else {
               ScriptBytecodeAdapter.assertFailed(AssertionRenderer.render("assert args", var6), (Object)null);
            }
   ...
   public String getDescription() {
      ...
      return (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{var1[2].call(this.args, (Object)" ")}, new String[]{"User defined alias to: @|bold ", "|@"}), $get$$class$java$lang$String());
   }
   ...
   public String getHelp() {
      CallSite[] var1 = $getCallSiteArray();
      return (String)ScriptBytecodeAdapter.castToType(var1[3].callGroovyObjectGetProperty(this), $get$$class$java$lang$String());
   }

   public Object execute(List args) {
      CallSite[] var2 = $getCallSiteArray();
      args = (List)ScriptBytecodeAdapter.castToType(var2[4].call(this.args, (Object)args), $get$$class$java$util$List());
      var2[5].call(var2[6].callGroovyObjectGetProperty(this), (Object)(new GStringImpl(new Object[]{args}, new String[]{"Executing with args: ", ""})));
      return (Object)ScriptBytecodeAdapter.castToType(var2[7].call(var2[8].callGroovyObjectGetProperty(this), var2[9].call(args, (Object)" ")), $get$$class$java$lang$Object());
   }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$org$codehaus$groovy$tools$shell$commands$AliasTargetProxyCommand();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$org$codehaus$groovy$tools$shell$commands$AliasTargetProxyCommand(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$org$codehaus$groovy$tools$shell$commands$AliasTargetProxyCommand(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$org$codehaus$groovy$tools$shell$commands$AliasTargetProxyCommand(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$org$codehaus$groovy$tools$shell$commands$AliasTargetProxyCommand() {
      Class var10000 = $class$org$codehaus$groovy$tools$shell$commands$AliasTargetProxyCommand;
      if (var10000 == null) {
         var10000 = $class$org$codehaus$groovy$tools$shell$commands$AliasTargetProxyCommand = class$("org.codehaus.groovy.tools.shell.commands.AliasTargetProxyCommand");
      }
