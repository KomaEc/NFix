...
public class ClearCommand extends CommandSupport {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204794L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204794 = (Long)0L;
   // $FF: synthetic field
   private static SoftReference $callSiteArray;
   // $FF: synthetic field
   private static Class $class$org$codehaus$groovy$tools$shell$commands$ClearCommand;
   // $FF: synthetic field
   ...
   public ClearCommand(Shell shell) {
      ...
      Object[] var10000 = new Object[]{shell, "clear", "\\c"};
   ...
   public Object execute(List args) {
      ...
      var2[1].call(var2[2].callGroovyObjectGetProperty(this));
      return DefaultTypeTransformation.booleanUnbox(var2[3].callGetProperty(var2[4].callGroovyObjectGetProperty(this))) ? (Object)ScriptBytecodeAdapter.castToType(var2[5].call(var2[6].callGetProperty(var2[7].callGroovyObjectGetProperty(this)), (Object)"Buffer cleared"), $get$$class$java$lang$Object()) : (Object)ScriptBytecodeAdapter.castToType((Object)null, $get$$class$java$lang$Object());
   }
   ...
   public Object this$dist$invoke$3(String name, Object args) {
      ...
      Class var10000 = $get$$class$org$codehaus$groovy$tools$shell$commands$ClearCommand();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$org$codehaus$groovy$tools$shell$commands$ClearCommand(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$org$codehaus$groovy$tools$shell$commands$ClearCommand(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$org$codehaus$groovy$tools$shell$commands$ClearCommand(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$org$codehaus$groovy$tools$shell$commands$ClearCommand() {
      Class var10000 = $class$org$codehaus$groovy$tools$shell$commands$ClearCommand;
      if (var10000 == null) {
         var10000 = $class$org$codehaus$groovy$tools$shell$commands$ClearCommand = class$("org.codehaus.groovy.tools.shell.commands.ClearCommand");
      }
