...
public class HelpCommandCompletor extends SimpleCompletor implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524205476L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524205476 = (Long)0L;
   // $FF: synthetic field
   ...
   public HelpCommandCompletor(CommandRegistry registry) {
      ...
      try {
         if (DefaultTypeTransformation.booleanUnbox(var3.record(registry, 8))) {
            var3.clear();
         } else {
            ScriptBytecodeAdapter.assertFailed(AssertionRenderer.render("assert registry", var3), (Object)null);
         }
   ...
   public SortedSet getCandidates() {
      ...
      Object command = null;
      Object var4 = var1[1].call(this.registry);

      while(((Iterator)var4).hasNext()) {
         command = ((Iterator)var4).next();
         if (!DefaultTypeTransformation.booleanUnbox(var1[2].callGetProperty(command))) {
            var1[3].call(set, var1[4].callGetProperty(command));
            var1[5].call(set, var1[6].callGetProperty(command));
         }
      }
   ...
   public Object this$dist$invoke$4(String name, Object args) {
      ...
      Class var10000 = $get$$class$org$codehaus$groovy$tools$shell$commands$HelpCommandCompletor();
   ...
   public void this$dist$set$4(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$org$codehaus$groovy$tools$shell$commands$HelpCommandCompletor(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$4(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$org$codehaus$groovy$tools$shell$commands$HelpCommandCompletor(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$org$codehaus$groovy$tools$shell$commands$HelpCommandCompletor(), var0);
   }
