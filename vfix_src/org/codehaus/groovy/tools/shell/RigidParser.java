...
public final class RigidParser implements GroovyObject {
   private static final String SCRIPT_FILENAME = (String)"groovysh_parse";
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204043L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204043 = (Long)0L;
   // $FF: synthetic field
   ...
   public Object this$dist$invoke$2(String name, Object args) {
      ...
      Class var10000 = $get$$class$org$codehaus$groovy$tools$shell$RigidParser();
   ...
   public void this$dist$set$2(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$org$codehaus$groovy$tools$shell$RigidParser(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$2(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$org$codehaus$groovy$tools$shell$RigidParser(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static void $createCallSiteArray_1(String[] var0) {
      ...
      var0[9] = "COMPLETE";
      var0[10] = "errorCount";
      var0[11] = "errorCollector";
      var0[12] = "failedWithUnexpectedEOF";
      var0[13] = "trim";
      var0[14] = "getAt";
      var0[15] = "endsWith";
      var0[16] = "endsWith";
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$org$codehaus$groovy$tools$shell$RigidParser(), var0);
   }
