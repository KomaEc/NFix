...
public class TranformTestHelper implements GroovyObject {
   ...
   private static ClassInfo $staticClassInfo$;
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524203898L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524203898 = (Long)0L;
   // $FF: synthetic field
   private static SoftReference $callSiteArray;
   // $FF: synthetic field
   private static Class $class$org$codehaus$groovy$tools$ast$TranformTestHelper;
   // $FF: synthetic field
   ...
   public Class parse(File input) {
      ...
      TestHarnessClassLoader loader = var2[0].callConstructor($get$$class$org$codehaus$groovy$tools$ast$TestHarnessClassLoader(), this.transform, this.phase);
      return (Class)ScriptBytecodeAdapter.castToType(var2[1].call(loader, (Object)input), $get$$class$java$lang$Class());
   }
   ...
   public Object this$dist$invoke$2(String name, Object args) {
      CallSite[] var3 = $getCallSiteArray();
      Class var10000 = $get$$class$org$codehaus$groovy$tools$ast$TranformTestHelper();
   ...
   public void this$dist$set$2(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$org$codehaus$groovy$tools$ast$TranformTestHelper(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$2(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$org$codehaus$groovy$tools$ast$TranformTestHelper(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$org$codehaus$groovy$tools$ast$TranformTestHelper(), var0);
   }
   ...
   // $FF: synthetic method
   private static Class $get$$class$org$codehaus$groovy$tools$ast$TranformTestHelper() {
      Class var10000 = $class$org$codehaus$groovy$tools$ast$TranformTestHelper;
      if (var10000 == null) {
         var10000 = $class$org$codehaus$groovy$tools$ast$TranformTestHelper = class$("org.codehaus.groovy.tools.ast.TranformTestHelper");
      }
