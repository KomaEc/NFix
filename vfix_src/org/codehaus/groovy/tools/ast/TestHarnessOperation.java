...
private class TestHarnessOperation extends CompilationUnit.PrimaryClassNodeOperation implements GroovyObject {
   ...
   // $FF: synthetic field
   public static Long __timeStamp = (Long)1292524204706L;
   // $FF: synthetic field
   public static Long __timeStamp__239_neverHappen1292524204706 = (Long)0L;
   // $FF: synthetic field
   ...
   public void call(SourceUnit source, GeneratorContext context, ClassNode classNode) {
      ...
      var4[0].call(this.transform, (Object)null, source);
   }

   // $FF: synthetic method
   public Object this$dist$invoke$3(String name, Object args) {
      CallSite[] var3 = $getCallSiteArray();
      Class var10000 = $get$$class$org$codehaus$groovy$tools$ast$TestHarnessOperation();
   ...
   public void this$dist$set$3(String name, Object value) {
      CallSite[] var3 = $getCallSiteArray();
      ScriptBytecodeAdapter.setGroovyObjectField(value, $get$$class$org$codehaus$groovy$tools$ast$TestHarnessOperation(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }

   // $FF: synthetic method
   public Object this$dist$get$3(String name) {
      CallSite[] var2 = $getCallSiteArray();
      return ScriptBytecodeAdapter.getGroovyObjectField($get$$class$org$codehaus$groovy$tools$ast$TestHarnessOperation(), this, (String)ScriptBytecodeAdapter.castToType(new GStringImpl(new Object[]{name}, new String[]{"", ""}), $get$$class$java$lang$String()));
   }
   ...
   private static CallSiteArray $createCallSiteArray() {
      ...
      return new CallSiteArray($get$$class$org$codehaus$groovy$tools$ast$TestHarnessOperation(), var0);
   }
