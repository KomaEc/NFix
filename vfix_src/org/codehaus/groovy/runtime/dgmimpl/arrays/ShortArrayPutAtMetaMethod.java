...
public class ShortArrayPutAtMetaMethod extends ArrayPutAtMetaMethod {
   ...
   public CallSite createPojoCallSite(CallSite site, MetaClassImpl metaClass, MetaMethod metaMethod, Class[] params, Object receiver, Object[] args) {
      return (CallSite)(args[0] instanceof Integer && args[1] instanceof Short ? new ShortArrayPutAtMetaMethod.MyPojoMetaMethodSite(site, metaClass, metaMethod, params) : PojoMetaMethodSite.createNonAwareCallSite(site, metaClass, metaMethod, params, args));
   }
   ...
   private static class MyPojoMetaMethodSite extends PojoMetaMethodSite {
      ...
      public Object call(Object receiver, Object[] args) throws Throwable {
         if (receiver instanceof short[] && args[0] instanceof Integer && args[1] instanceof Short && this.checkPojoMetaClass()) {
            ...
            objects[ArrayMetaMethod.normaliseIndex((Integer)args[0], objects.length)] = (Short)args[1];
            return null;
         } else {
      ...
      public Object call(Object receiver, Object arg1, Object arg2) throws Throwable {
         if (this.checkPojoMetaClass()) {
            try {
               short[] objects = (short[])((short[])receiver);
               objects[ArrayMetaMethod.normaliseIndex((Integer)arg1, objects.length)] = (Short)arg2;
               return null;
