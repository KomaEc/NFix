...
public class SwingGroovyMethods {
   ...
   public static Iterator<Component> iterator(Container self) {
      return DefaultGroovyMethods.iterator((Object[])self.getComponents());
   }
   ...
   public static Iterator iterator(JComboBox self) {
      return iterator((ListModel)self.getModel());
   }
   ...
   public static Iterator iterator(JMenu self) {
      return DefaultGroovyMethods.iterator((Object[])self.getMenuComponents());
   }
   ...
   public static Iterator iterator(JMenuBar self) {
      return DefaultGroovyMethods.iterator((Object[])self.getSubElements());
   }
