...
public class MindMapPrinter extends VisitorAdapter {
   ...
   public void visitDefault(GroovySourceAST t, int visit) {
      if (visit == 1) {
         ...
         String colour = this.getColour(t);
   ...
   private String getFolded(GroovySourceAST t) {
      ...
      return t.getType() == 28 ? " FOLDED='true'" : "";
   }
   ...
   private String getName(GroovySourceAST t) {
      ...
      case 8:
      case 9:
         GroovySourceAST identNode = t.childOfType(84);
         if (identNode != null) {
      ...
      default:
         ...
         if (this.sourceBuffer != null) {
            ...
            name = name + "&#xa;";
            name = name + this.escape(this.sourceBuffer.getSnippet(new LineColumn(t.getLine(), t.getColumn()), new LineColumn(t.getLineLast(), t.getColumnLast())));
         }
