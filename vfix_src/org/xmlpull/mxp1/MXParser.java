...
public class MXParser implements XmlPullParser {
   ...
   protected static final char[] VERSION = new char[]{'v', 'e', 'r', 's', 'i', 'o', 'n'};
   protected static final char[] NCODING = new char[]{'n', 'c', 'o', 'd', 'i', 'n', 'g'};
   protected static final char[] TANDALONE = new char[]{'t', 'a', 'n', 'd', 'a', 'l', 'o', 'n', 'e'};
   protected static final char[] YES = new char[]{'y', 'e', 's'};
   protected static final char[] NO = new char[]{'n', 'o'};
   ...
   public Object getProperty(String name) {
      if (name == null) {
         ...
         return "http://xmlpull.org/v1/doc/properties.html#xmldecl-content".equals(name) ? this.xmlDeclContent : null;
      }
   }
            ...
            if (!this.isNameChar(ch)) {
               ...
               if (this.processNamespaces) {
                  ...
                  for(i = 0; i < this.attributeCount; ++i) {
                     ...
                     if (attrPrefix != null) {
                        attrUri = this.getNamespace(attrPrefix);
                        if (attrUri == null) {
                  ...
                  for(int i = 1; i < this.attributeCount; ++i) {
                     for(i = 0; i < i; ++i) {
                        if (this.allStringsInterned && this.attributeName[i].equals(this.attributeName[i]) || !this.allStringsInterned && this.attributeNameHash[i] == this.attributeNameHash[i] && this.attributeName[i].equals(this.attributeName[i])) {
                           ...
                           throw new XmlPullParserException("duplicated attributes " + attrPrefix + " and " + attrUri, this, (Throwable)null);
                        }
                     }
                  }
               }
