...
public class VelocityFormatter {
   ...
   public String makeAlternator(String name, String alt1, String alt2) {
      ...
      this.context.put(name, new VelocityFormatter.VelocityAlternator(alternates));
      return "";
   }
   ...
   public String makeAutoAlternator(String name, String alt1, String alt2) {
      String[] alternates = new String[]{alt1, alt2};
      this.context.put(name, new VelocityFormatter.VelocityAutoAlternator(alternates));
      return "";
   }
   ...
   public class VelocityAutoAlternator extends VelocityFormatter.VelocityAlternator {
