...
public class CursorableLinkedList implements List, Serializable {
   ...
   protected transient CursorableLinkedList.Listable _head = new CursorableLinkedList.Listable((CursorableLinkedList.Listable)null, (CursorableLinkedList.Listable)null, (Object)null);
   protected transient int _modCount = 0;
   protected transient List _cursors = new ArrayList();

   public boolean add(Object o) {
      this.insertListable(this._head.prev(), (CursorableLinkedList.Listable)null, o);
      return true;
   }
   ...
   public boolean addAll(Collection c) {
      if (c.isEmpty()) {
         ...
         while(it.hasNext()) {
            this.insertListable(this._head.prev(), (CursorableLinkedList.Listable)null, it.next());
         }
   ...
   public boolean addFirst(Object o) {
      this.insertListable((CursorableLinkedList.Listable)null, this._head.next(), o);
      return true;
   }
   ...
   public boolean contains(Object o) {
      ...
      CursorableLinkedList.Listable past = null;
   ...
   public int indexOf(Object o) {
      int ndx = 0;
      CursorableLinkedList.Listable elt;
      CursorableLinkedList.Listable past;
      if (null == o) {
         elt = this._head.next();
   ...
   private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
      ...
      this._head = new CursorableLinkedList.Listable((CursorableLinkedList.Listable)null, (CursorableLinkedList.Listable)null, (Object)null);
      int size = in.readInt();
   ...
   public class Cursor extends CursorableLinkedList.ListIter implements ListIterator {
      ...
      public void add(Object o) {
         this.checkForComod();
         CursorableLinkedList.Listable elt = CursorableLinkedList.this.insertListable(super._cur.prev(), super._cur.next(), o);
      ...
      protected void listableRemoved(CursorableLinkedList.Listable elt) {
         if (null == CursorableLinkedList.this._head.prev()) {
            super._cur.setNext((CursorableLinkedList.Listable)null);
         } else if (super._cur.next() == elt) {
            super._cur.setNext(elt.next());
         }

         if (null == CursorableLinkedList.this._head.next()) {
            super._cur.setPrev((CursorableLinkedList.Listable)null);
   ...
   class ListIter implements ListIterator {
      ...
      ListIter(int index) {
         ...
         this._nextIndex = 0;
         if (index == 0) {
            this._cur = new CursorableLinkedList.Listable((CursorableLinkedList.Listable)null, CursorableLinkedList.this._head.next(), (Object)null);
            this._nextIndex = 0;
         } else if (index == CursorableLinkedList.this._size) {
            this._cur = new CursorableLinkedList.Listable(CursorableLinkedList.this._head.prev(), (CursorableLinkedList.Listable)null, (Object)null);
            ...
            this._cur = new CursorableLinkedList.Listable(temp.prev(), temp, (Object)null);
