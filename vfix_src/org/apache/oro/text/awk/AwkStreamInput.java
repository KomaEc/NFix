...
public final class AwkStreamInput {
   ...
   int _reallocate(int var1) throws IOException {
      if (this._endOfStreamReached) {
         ...
         char[] var3 = new char[var2 + this.__bufferIncrementUnit];
         int var4 = this.__searchStream.read(var3, var2, this.__bufferIncrementUnit);
         if (var4 <= 0) {
            ...
            this._bufferSize = var2 + var4;
            System.arraycopy(this._buffer, var1, var3, 0, var2);
            this._buffer = var3;
            return var2;
         }
      }
