...
public final class AwkMatcher implements PatternMatcher {
   ...
   private int __streamMatchPrefix() throws IOException {
      ...
      int var2 = -1;
      int var3;
      int var4 = var3 = this.__offsets[0];
      int var5 = this.__streamSearchBuffer._bufferSize + this.__beginOffset;

      while(var4 < var5) {
         char var6 = this.__streamSearchBuffer._buffer[var4++];
         if (var1 >= this.__awkPattern._numStates) {
            break;
         }

         int var7 = var1;
         int[] var8 = this.__awkPattern._getStateArray(var1);
         var1 = var8[var6];
         if (var1 == 0) {
            this.__awkPattern._createNewState(var7, var6, var8);
            var1 = var8[var6];
         }
         ...
         if (this.__awkPattern._endStates.get(var1)) {
            var2 = var4;
         }

         if (var4 == var5) {
            var4 = this.__streamSearchBuffer._reallocate(var3) + this.__beginOffset;
            var5 = this.__streamSearchBuffer._bufferSize + this.__beginOffset;
            if (var4 != var5) {
               if (var2 != -1) {
                  var2 -= var3;
               }
      ...
      this.__offsets[0] = var3;
      this.__offsets[1] = var2 - 1;
      if (var2 == -1 && this.__awkPattern._matchesNullString) {
         return 0;
      } else {
         return !this.__awkPattern._hasEndAnchor || this.__streamSearchBuffer._endOfStreamReached && var2 >= this.__streamSearchBuffer._bufferSize + this.__beginOffset ? var2 - var3 : -1;
      }
   }
