...
public final class AwkPattern implements Pattern, Serializable {
   ...
   AwkPattern(String var1, SyntaxTree var2) {
      ...
      DFAState var4 = new DFAState((BitSet)this._U.clone(), this._numStates);
      this._stateMap = new Hashtable();
      this._stateMap.put(var4._state, var4);
      this._stateList.addElement(var4);
      this._stateList.addElement(var4);
      ++this._numStates;
      this._U.xor(this._U);
      ...
      for(int var5 = 0; var5 < 256; ++var5) {
         this._nodeList[var5] = new Vector();

         for(int var6 = 0; var6 < var2._positions; ++var6) {
            if (var2._nodes[var6]._matches((char)var5)) {
               this._nodeList[var5].addElement(var2._nodes[var6]);
            }
         }
      }
   ...
   void _createNewState(int var1, int var2, int[] var3) {
      DFAState var4 = (DFAState)this._stateList.elementAt(var1);
      int var5 = this._nodeList[var2].size();
      this._U.xor(this._U);

      while(var5-- > 0) {
         int var6 = ((LeafNode)this._nodeList[var2].elementAt(var5))._position;
         if (var4._state.get(var6)) {
            this._U.or(this._followSet[var6]);
         }
      }
