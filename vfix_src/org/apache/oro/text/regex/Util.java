...
public final class Util {
   ...
   public static void split(Collection var0, PatternMatcher var1, Pattern var2, String var3, int var4) {
      PatternMatcherInput var5 = new PatternMatcherInput(var3);
      int var6 = 0;

      while(true) {
         --var4;
         if (var4 == 0 || !var1.contains(var5, var2)) {
            var0.add(var3.substring(var6, var3.length()));
            return;
         }

         MatchResult var7 = var1.getMatch();
         var0.add(var3.substring(var6, var7.beginOffset(0)));
         var6 = var7.endOffset(0);
      }
   }
   ...
   public static int substitute(StringBuffer var0, PatternMatcher var1, Pattern var2, Substitution var3, PatternMatcherInput var4, int var5) {
      int var6 = 0;
      int var7 = var4.getBeginOffset();

      char[] var8;
      for(var8 = var4.getBuffer(); var5 != 0 && var1.contains(var4, var2); var7 = var4.getMatchEndOffset()) {
         --var5;
         ++var6;
         var0.append(var8, var7, var4.getMatchBeginOffset() - var7);
         var3.appendSubstitution(var0, var1.getMatch(), var6, var4, var1, var2);
      }

      var0.append(var8, var7, var4.length() - var7);
      return var6;
   }
}
