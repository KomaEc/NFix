...
public class DecorationXpp3Reader {
   ...
   private Banner parseBanner(String tagName, XmlPullParser parser, boolean strict) throws IOException, XmlPullParserException {
      ...
      while(true) {
         while(parser.nextTag() == 2) {
            ...
            } else if (this.checkFieldWithDuplicate(parser, "src", (String)null, parsed)) {
               banner.setSrc(this.getTrimmedValue(parser.nextText()));
            } else if (this.checkFieldWithDuplicate(parser, "alt", (String)null, parsed)) {
               banner.setAlt(this.getTrimmedValue(parser.nextText()));
            } else if (this.checkFieldWithDuplicate(parser, "href", (String)null, parsed)) {
   ...
   private Body parseBody(String tagName, XmlPullParser parser, boolean strict) throws IOException, XmlPullParserException {
      Body body = new Body();
      HashSet parsed = new HashSet();
      ...
      while(true) {
         label80:
         while(parser.nextTag() == 2) {
            if (this.checkFieldWithDuplicate(parser, "head", (String)null, parsed)) {
               body.setHead(Xpp3DomBuilder.build(parser));
            } else {
               ArrayList breadcrumbs;
               if (this.checkFieldWithDuplicate(parser, "links", (String)null, parsed)) {
                  breadcrumbs = new ArrayList();
                  body.setLinks(breadcrumbs);
               ...
               } else if (!this.checkFieldWithDuplicate(parser, "breadcrumbs", (String)null, parsed)) {
                  if (parser.getName().equals("menu")) {
                     List menus = body.getMenus();
                     if (menus == null) {
                        menus = new ArrayList();
                        body.setMenus((List)menus);
                     }

                     ((List)menus).add(this.parseMenu("menu", parser, strict));
                  } else {
                     if (strict) {
                        throw new XmlPullParserException("Unrecognised tag: '" + parser.getName() + "'", parser, (Throwable)null);
                     }
   ...
   private DecorationModel parseDecorationModel(String tagName, XmlPullParser parser, boolean strict) throws IOException, XmlPullParserException {
      ...
      for(boolean foundRoot = false; eventType != 1; eventType = parser.next()) {
         if (eventType == 2) {
            if (parser.getName().equals(tagName)) {
               ...
               if (this.checkFieldWithDuplicate(parser, "bannerLeft", (String)null, parsed)) {
                  decorationModel.setBannerLeft(this.parseBanner("bannerLeft", parser, strict));
               } else if (this.checkFieldWithDuplicate(parser, "bannerRight", (String)null, parsed)) {
                  decorationModel.setBannerRight(this.parseBanner("bannerRight", parser, strict));
               } else if (this.checkFieldWithDuplicate(parser, "publishDate", (String)null, parsed)) {
               ...
               } else if (!this.checkFieldWithDuplicate(parser, "poweredBy", (String)null, parsed)) {
                  if (this.checkFieldWithDuplicate(parser, "skin", (String)null, parsed)) {
                     decorationModel.setSkin(this.parseSkin("skin", parser, strict));
                  } else if (this.checkFieldWithDuplicate(parser, "body", (String)null, parsed)) {
                     decorationModel.setBody(this.parseBody("body", parser, strict));
                  } else if (this.checkFieldWithDuplicate(parser, "custom", (String)null, parsed)) {
                     decorationModel.setCustom(Xpp3DomBuilder.build(parser));
                  } else if (strict) {
                     throw new XmlPullParserException("Unrecognised tag: '" + parser.getName() + "'", parser, (Throwable)null);
                  }
               } else {
                  List poweredBy = new ArrayList();
   ...
   private LinkItem parseLinkItem(String tagName, XmlPullParser parser, boolean strict) throws IOException, XmlPullParserException {
   ...
   private Logo parseLogo(String tagName, XmlPullParser parser, boolean strict) throws IOException, XmlPullParserException {
      Logo logo = new Logo();
   ...
   private Menu parseMenu(String tagName, XmlPullParser parser, boolean strict) throws IOException, XmlPullParserException {
      Menu menu = new Menu();
      if (parser.getAttributeValue("", "name") != null) {
      ...
      while(true) {
         while(parser.nextTag() == 2) {
            if (parser.getName().equals("item")) {
               ...
               if (items == null) {
                  items = new ArrayList();
                  menu.setItems((List)items);
               }

               ((List)items).add(this.parseMenuItem("item", parser, strict));
            } else {
               if (strict) {
                  throw new XmlPullParserException("Unrecognised tag: '" + parser.getName() + "'", parser, (Throwable)null);
               }
   ...
   private MenuItem parseMenuItem(String tagName, XmlPullParser parser, boolean strict) throws IOException, XmlPullParserException {
      ...
      while(true) {
         while(parser.nextTag() == 2) {
            if (this.checkFieldWithDuplicate(parser, "description", (String)null, parsed)) {
               menuItem.setDescription(this.getTrimmedValue(parser.nextText()));
            } else if (parser.getName().equals("item")) {
               List items = menuItem.getItems();
               if (items == null) {
                  items = new ArrayList();
                  menuItem.setItems((List)items);
               }
   ...
   private PublishDate parsePublishDate(String tagName, XmlPullParser parser, boolean strict) throws IOException, XmlPullParserException {
   ...
   private Skin parseSkin(String tagName, XmlPullParser parser, boolean strict) throws IOException, XmlPullParserException {
      Skin skin = new Skin();
      HashSet parsed = new HashSet();
   ...
   private Version parseVersion(String tagName, XmlPullParser parser, boolean strict) throws IOException, XmlPullParserException {
