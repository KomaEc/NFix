...
public class PluginDescriptorBuilder {
   public PluginDescriptor build(Reader reader) throws PlexusConfigurationException {
      return this.build(reader, (String)null);
   }
   ...
   public PlexusConfiguration buildConfiguration(Reader configuration) throws PlexusConfigurationException {
      try {
         ...
         throw new PlexusConfigurationException("Error creating configuration", var3);
      } catch (XmlPullParserException var4) {
         throw new PlexusConfigurationException("Error creating configuration", var4);
      }
   }
}
