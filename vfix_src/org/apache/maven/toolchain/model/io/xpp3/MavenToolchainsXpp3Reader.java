...
public class MavenToolchainsXpp3Reader {
   ...
   private PersistedToolchains parsePersistedToolchains(String tagName, XmlPullParser parser, boolean strict) throws IOException, XmlPullParserException {
            ...
            if (parser.getName().equals(tagName)) {
               ...
               if (parser.getName().equals("toolchain")) {
                  ...
                  if (toolchains == null) {
                     ...
                     persistedToolchains.setToolchains((List)toolchains);
                  }

                  ((List)toolchains).add(this.parseToolchainModel("toolchain", parser, strict));
               } else if (strict) {
   ...
   private ToolchainModel parseToolchainModel(String tagName, XmlPullParser parser, boolean strict) throws IOException, XmlPullParserException {
      ...
      while(true) {
         while(parser.nextTag() == 2) {
            ...
            } else if (this.checkFieldWithDuplicate(parser, "provides", (String)null, parsed)) {
