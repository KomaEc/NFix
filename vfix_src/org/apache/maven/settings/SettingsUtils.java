...
public final class SettingsUtils {
      ...
      if (dominant != null && recessive != null) {
         ...
         if (recessiveActiveProfiles != null) {
            if (dominantActiveProfiles == null) {
               ...
               dominant.setActiveProfiles((List)dominantActiveProfiles);
            }
            ...
            while(it.hasNext()) {
               ...
               if (!((List)dominantActiveProfiles).contains(profileId)) {
                  ((List)dominantActiveProfiles).add(profileId);
         ...
         if (recessivePluginGroupIds != null) {
            if (dominantPluginGroupIds == null) {
               ...
               dominant.setPluginGroups((List)dominantPluginGroupIds);
            }

            Iterator it = recessivePluginGroupIds.iterator();

            while(it.hasNext()) {
               String pluginGroupId = (String)it.next();
               if (!((List)dominantPluginGroupIds).contains(pluginGroupId)) {
                  ((List)dominantPluginGroupIds).add(pluginGroupId);
   ...
   public static org.apache.maven.model.Profile convertFromSettingsProfile(Profile settingsProfile) {
      ...
      if (settingsActivation != null) {
         ...
         ActivationFile settingsFile = settingsActivation.getFile();
