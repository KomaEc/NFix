...
public class ParamdocXpp3Reader {
   ...
   private Expression parseExpression(String tagName, XmlPullParser parser, boolean strict, String encoding) throws IOException, XmlPullParserException {
      ...
      while(true) {
         while(parser.nextTag() == 2) {
            if (parser.getName().equals("syntax")) {
               ...
               String key;
               String value;
               if (parser.getName().equals("cliOptions")) {
                  ...
                  for(; parser.nextTag() == 2; parser.next()) {
                  ...
                  if (parser.getName().equals("deprecation")) {
   ...
   private ExpressionDocumentation parseExpressionDocumentation(String tagName, XmlPullParser parser, boolean strict, String encoding) throws IOException, XmlPullParserException {
