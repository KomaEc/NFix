...
public class DefaultModelInheritanceAssembler implements ModelInheritanceAssembler {
   public void copyModel(Model dest, Model source) {
      this.assembleModelInheritance(dest, source, (String)null, false);
   }
   ...
   public void assembleModelInheritance(Model child, Model parent) {
      this.assembleModelInheritance(child, parent, (String)null, true);
   }
   ...
   private void assembleDistributionInheritence(Model child, Model parent, String childPathAdjustment, boolean appendPaths) {
      if (parent.getDistributionManagement() != null) {
         ...
         if (childDistMgmt.getRepository() == null && parentDistMgmt.getRepository() != null) {
            repository = copyDistributionRepository(parentDistMgmt.getRepository());
            childDistMgmt.setRepository(repository);
         }

         if (childDistMgmt.getSnapshotRepository() == null && parentDistMgmt.getSnapshotRepository() != null) {
            repository = copyDistributionRepository(parentDistMgmt.getSnapshotRepository());
   ...
   protected String appendPath(String parentPath, String childPath, String pathAdjustment, boolean appendPaths) {
      ...
      if (appendPaths) {
         if (pathAdjustment != null) {
            uncleanPath = parentPath + "/" + pathAdjustment;
         }
