...
public final class ProjectUtils {
   ...
   private static ArtifactRepositoryLayout getRepositoryLayout(RepositoryBase mavenRepo, PlexusContainer container) throws InvalidRepositoryException {
      String layout = mavenRepo.getLayout();

      try {
         ArtifactRepositoryLayout repositoryLayout = (ArtifactRepositoryLayout)container.lookup(ArtifactRepositoryLayout.ROLE, layout);
         return repositoryLayout;
      } catch (ComponentLookupException var5) {
         throw new InvalidRepositoryException("Cannot find layout implementation corresponding to: '" + layout + "' for remote repository with id: '" + mavenRepo.getId() + "'.", var5);
      }
   }
}
